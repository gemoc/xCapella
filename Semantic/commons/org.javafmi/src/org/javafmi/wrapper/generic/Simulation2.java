...
public class Simulation2 {
    ...
    protected Simulation2() {
    }

    public Simulation2(String fmuPath) {
     ...
     */
    @Deprecated
    public Simulation2(String fmuPath, long timeout) {
        this(new FmuFile(fmuPath));
    }

    Simulation2(FmuFile fmuFile) {
    ...
    protected static FmuProxy getProxy(Simulation2 simulation) {
