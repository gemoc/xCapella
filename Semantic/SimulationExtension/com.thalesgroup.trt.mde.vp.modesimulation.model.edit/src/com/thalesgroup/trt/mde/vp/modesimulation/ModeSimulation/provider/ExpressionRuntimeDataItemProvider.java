...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.trt.mde.vp.modesimulation.ModeSimulation.ExpressionRuntimeData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExpressionRuntimeDataItemProvider extends NamedElementItemProvider
	 ...
	 * @generated
	 */
	public ExpressionRuntimeDataItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ExpressionRuntimeData.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/ExpressionRuntimeData")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		String label = ((ExpressionRuntimeData) object).getName();
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_ExpressionRuntimeData_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
