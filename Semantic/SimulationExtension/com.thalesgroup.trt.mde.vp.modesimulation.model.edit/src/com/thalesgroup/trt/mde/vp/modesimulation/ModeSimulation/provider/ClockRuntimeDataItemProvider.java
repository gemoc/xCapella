...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.trt.mde.vp.modesimulation.ModeSimulation.ClockRuntimeData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClockRuntimeDataItemProvider extends NamedElementItemProvider
	 ...
	 * @generated
	 */
	public ClockRuntimeDataItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addNumberOfTicksPropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors
				...
				(((ComposeableAdapterFactory) adapterFactory)
						...
						getResourceLocator(),
						getString("_UI_ClockRuntimeData_numberOfTicks_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_ClockRuntimeData_numberOfTicks_feature", "_UI_ClockRuntimeData_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						ModeSimulationPackage.Literals.CLOCK_RUNTIME_DATA__NUMBER_OF_TICKS,
						true, false, false,
	...
	/**
	 * This returns ClockRuntimeData.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/ClockRuntimeData")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		String label = ((ClockRuntimeData) object).getName();
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_ClockRuntimeData_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ClockRuntimeData.class)) {
