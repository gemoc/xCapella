...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.trt.mde.vp.modesimulation.ModeSimulation.TransitionRuntimeData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionRuntimeDataItemProvider extends NamedElementItemProvider
	 ...
	 * @generated
	 */
	public TransitionRuntimeDataItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns TransitionRuntimeData.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/TransitionRuntimeData")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		String label = ((TransitionRuntimeData) object).getName();
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_TransitionRuntimeData_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
