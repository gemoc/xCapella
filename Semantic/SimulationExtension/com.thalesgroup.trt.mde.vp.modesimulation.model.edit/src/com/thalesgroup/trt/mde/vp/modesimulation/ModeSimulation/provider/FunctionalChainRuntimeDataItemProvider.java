...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.trt.mde.vp.modesimulation.ModeSimulation.FunctionalChainRuntimeData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionalChainRuntimeDataItemProvider extends
	 ...
	 * @generated
	 */
	public FunctionalChainRuntimeDataItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addIsActivePropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors
				...
				(((ComposeableAdapterFactory) adapterFactory)
						...
						getResourceLocator(),
						getString("_UI_FunctionalChainRuntimeData_isActive_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_FunctionalChainRuntimeData_isActive_feature", "_UI_FunctionalChainRuntimeData_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						ModeSimulationPackage.Literals.FUNCTIONAL_CHAIN_RUNTIME_DATA__IS_ACTIVE,
						true, false, false,
	...
	/**
	 * This returns FunctionalChainRuntimeData.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/FunctionalChainRuntimeData")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		String label = ((FunctionalChainRuntimeData) object).getName();
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_FunctionalChainRuntimeData_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FunctionalChainRuntimeData.class)) {
