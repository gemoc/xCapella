...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.trt.mde.vp.modesimulation.ModeSimulation.EventRuntimeData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventRuntimeDataItemProvider extends NamedElementItemProvider
	 ...
	 * @generated
	 */
	public EventRuntimeDataItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addSollicitingTransitionsPropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors
				...
				(((ComposeableAdapterFactory) adapterFactory)
						...
						getResourceLocator(),
						getString("_UI_EventRuntimeData_sollicitingTransitions_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_EventRuntimeData_sollicitingTransitions_feature", "_UI_EventRuntimeData_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						ModeSimulationPackage.Literals.EVENT_RUNTIME_DATA__SOLLICITING_TRANSITIONS,
	...
	/**
	 * This returns EventRuntimeData.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/EventRuntimeData")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		String label = ((EventRuntimeData) object).getName();
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_EventRuntimeData_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
