...
public class RoleAssemblyUsageAdapter extends EObjectAdapter<RoleAssemblyUsage> implements org.gemoc.scenario.xdsml.functionscenariomt.oa.RoleAssemblyUsage {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public RoleAssemblyUsageAdapter() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.oa.Role getChild() {
    return () adaptersFactory.createAdapter(adaptee.getChild(), eResource);
  }
  
  @Override
  public void setChild(final org.gemoc.scenario.xdsml.functionscenariomt.oa.Role o) {
    if (o != null)
    	adaptee.setChild(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.oa.RoleAdapter) o).getAdaptee());
    else adaptee.setChild(null);
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.eINSTANCE.getRoleAssemblyUsage();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__CHILD:
    		return getChild();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ROLE_ASSEMBLY_USAGE__CHILD:
    		setChild(
    		(org.gemoc.scenario.xdsml.functionscenariomt.oa.Role)
    		 newValue);
    		return;
    }
