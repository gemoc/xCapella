...
public class AbstractCapabilityExtensionPointAdapter extends EObjectAdapter<AbstractCapabilityExtensionPoint> implements org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapabilityExtensionPoint {
  ...
  @Override
  public void setAbstractCapability(final org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapability o) {
    if (o != null)
    	adaptee.setAbstractCapability(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.interaction.AbstractCapabilityAdapter) o).getAdaptee());
    else adaptee.setAbstractCapability(null);
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapabilityExtend> */Object extendLinks_;
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.eINSTANCE.getAbstractCapabilityExtensionPoint();
  }
  ...
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTENSION_POINT__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTENSION_POINT__CONSTRAINTS:
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTENSION_POINT__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTENSION_POINT__OUTGOING_TRACES:
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTENSION_POINT__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTENSION_POINT__APPLIED_REQUIREMENTS:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTENSION_POINT__ABSTRACT_CAPABILITY:
    		return getAbstractCapability() != null;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTENSION_POINT__EXTEND_LINKS:
    		return getExtendLinks() != null && !getExtendLinks().isEmpty();
    }
    ...
    if (baseClass == org.gemoc.scenario.xdsml.functionscenariomt.modellingcore.AbstractNamedElement.class) {
    	switch (baseFeatureID) {
    		case org.gemoc.scenario.xdsml.functionscenariomt.modellingcore.ModellingcorePackage.ABSTRACT_NAMED_ELEMENT__NAME:
    			return org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTENSION_POINT__NAME;
    		default: return -1;
    	}
    }
    if (baseClass == org.gemoc.scenario.xdsml.functionscenariomt.capellacore.NamedElement.class) {
