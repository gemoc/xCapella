...
public class ActorPkgAdapter extends EObjectAdapter<ActorPkg> implements org.gemoc.scenario.xdsml.functionscenariomt.ctx.ActorPkg {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public ActorPkgAdapter() {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Actor> */Object ownedActors_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Actor> */Object getOwnedActors() {
    if (ownedActors_ == null)
    	ownedActors_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedActors(), adaptersFactory, eResource);
    return ownedActors_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.ActorPkg> */Object ownedActorPkgs_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.ActorPkg> */Object getOwnedActorPkgs() {
    if (ownedActorPkgs_ == null)
    	ownedActorPkgs_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedActorPkgs(), adaptersFactory, eResource);
    return ownedActorPkgs_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCommunication> */Object ownedSystemCommunication_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCommunication> */Object getOwnedSystemCommunication() {
    if (ownedSystemCommunication_ == null)
    	ownedSystemCommunication_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedSystemCommunication(), adaptersFactory, eResource);
    return ownedSystemCommunication_;
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.eINSTANCE.getActorPkg();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_TRACES:
    		return getOwnedTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__CONTAINED_GENERIC_TRACES:
    		return getContainedGenericTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__CONTAINED_REQUIREMENTS_TRACES:
    		return getContainedRequirementsTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__NAMING_RULES:
    		return getNamingRules();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_PROPERTY_VALUE_PKGS:
    		return getOwnedPropertyValuePkgs();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_ACTORS:
    		return getOwnedActors();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_ACTOR_PKGS:
    		return getOwnedActorPkgs();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_SYSTEM_COMMUNICATION:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_ACTORS:
    		return getOwnedActors() != null && !getOwnedActors().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_ACTOR_PKGS:
    		return getOwnedActorPkgs() != null && !getOwnedActorPkgs().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_SYSTEM_COMMUNICATION:
    		return getOwnedSystemCommunication() != null && !getOwnedSystemCommunication().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_ACTORS:
    		...
    		getOwnedActors().addAll((Collection) newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_ACTOR_PKGS:
    		getOwnedActorPkgs().clear();
    		getOwnedActorPkgs().addAll((Collection) newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR_PKG__OWNED_SYSTEM_COMMUNICATION:
    		getOwnedSystemCommunication().clear();
    		getOwnedSystemCommunication().addAll((Collection) newValue);
    		return;
    }
