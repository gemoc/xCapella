...
public class AcceptEventActionAdapter extends EObjectAdapter<AcceptEventAction> implements org.gemoc.scenario.xdsml.functionscenariomt.activity.AcceptEventAction {
  ...
  public boolean isIsUnmarshall() {
    return adaptee.isIsUnmarshall();
  }
  
  @Override
  public void setIsUnmarshall(final boolean o) {
    adaptee.setIsUnmarshall(o);
  }
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.activity.OutputPin> */Object result_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.activity.OutputPin> */Object getResult() {
    if (result_ == null)
    	result_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getResult(), adaptersFactory, eResource);
    return result_;
  }
  ...
  protected final static boolean IS_UNMARSHALL_EDEFAULT = false;
  
  @Override
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.eINSTANCE.getAcceptEventAction();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__IN_ACTIVITY_PARTITION:
    		return getInActivityPartition();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__IN_INTERRUPTIBLE_REGION:
    		return getInInterruptibleRegion();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__IN_STRUCTURED_NODE:
    		return getInStructuredNode();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__OUTGOING:
    		return getOutgoing();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__INCOMING:
    		return getIncoming();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__OWNED_HANDLERS:
    		return getOwnedHandlers();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__LOCAL_PRECONDITION:
    		return getLocalPrecondition();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__LOCAL_POSTCONDITION:
    		return getLocalPostcondition();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__CONTEXT:
    		return getContext();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__INPUTS:
    		return getInputs();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__OUTPUTS:
    		return getOutputs();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__IS_UNMARSHALL:
    		return isIsUnmarshall() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__RESULT:
    		return getResult();
    }
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__IS_UNMARSHALL:
    		return isIsUnmarshall() != IS_UNMARSHALL_EDEFAULT;
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__RESULT:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__OUTPUTS:
    		...
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__IS_UNMARSHALL:
    		setIsUnmarshall(((java.lang.Boolean) newValue).booleanValue());
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.ACCEPT_EVENT_ACTION__RESULT:
    		getResult().clear();
