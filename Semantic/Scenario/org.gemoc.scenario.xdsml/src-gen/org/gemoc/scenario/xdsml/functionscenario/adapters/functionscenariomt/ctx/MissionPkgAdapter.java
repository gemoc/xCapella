...
public class MissionPkgAdapter extends EObjectAdapter<MissionPkg> implements org.gemoc.scenario.xdsml.functionscenariomt.ctx.MissionPkg {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public MissionPkgAdapter() {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.MissionPkg> */Object ownedMissionPkgs_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.MissionPkg> */Object getOwnedMissionPkgs() {
    if (ownedMissionPkgs_ == null)
    	ownedMissionPkgs_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedMissionPkgs(), adaptersFactory, eResource);
    return ownedMissionPkgs_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Mission> */Object ownedMissions_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Mission> */Object getOwnedMissions() {
    if (ownedMissions_ == null)
    	ownedMissions_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedMissions(), adaptersFactory, eResource);
    return ownedMissions_;
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.eINSTANCE.getMissionPkg();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OWNED_TRACES:
    		return getOwnedTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__CONTAINED_GENERIC_TRACES:
    		return getContainedGenericTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__CONTAINED_REQUIREMENTS_TRACES:
    		return getContainedRequirementsTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__NAMING_RULES:
    		return getNamingRules();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OWNED_PROPERTY_VALUE_PKGS:
    		return getOwnedPropertyValuePkgs();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OWNED_MISSION_PKGS:
    		return getOwnedMissionPkgs();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OWNED_MISSIONS:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OWNED_MISSION_PKGS:
    		return getOwnedMissionPkgs() != null && !getOwnedMissionPkgs().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OWNED_MISSIONS:
    		return getOwnedMissions() != null && !getOwnedMissions().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OWNED_MISSION_PKGS:
    		...
    		getOwnedMissionPkgs().addAll((Collection) newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.MISSION_PKG__OWNED_MISSIONS:
    		getOwnedMissions().clear();
    		getOwnedMissions().addAll((Collection) newValue);
    		return;
    }
