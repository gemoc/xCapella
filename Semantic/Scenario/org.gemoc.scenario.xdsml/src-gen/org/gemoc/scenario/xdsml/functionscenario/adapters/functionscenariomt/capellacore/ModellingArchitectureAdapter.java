...
public class ModellingArchitectureAdapter extends EObjectAdapter<ModellingArchitecture> implements org.gemoc.scenario.xdsml.functionscenariomt.capellacore.ModellingArchitecture {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public ModellingArchitectureAdapter() {
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.eINSTANCE.getModellingArchitecture();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__OWNED_TRACES:
    		return getOwnedTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__CONTAINED_GENERIC_TRACES:
    		return getContainedGenericTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__CONTAINED_REQUIREMENTS_TRACES:
    		return getContainedRequirementsTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__NAMING_RULES:
    		return getNamingRules();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.MODELLING_ARCHITECTURE__OWNED_PROPERTY_VALUE_PKGS:
