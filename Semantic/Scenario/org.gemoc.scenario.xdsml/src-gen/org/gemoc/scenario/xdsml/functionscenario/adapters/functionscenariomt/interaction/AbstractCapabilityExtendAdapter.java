...
public class AbstractCapabilityExtendAdapter extends EObjectAdapter<AbstractCapabilityExtend> implements org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapabilityExtend {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public AbstractCapabilityExtendAdapter() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapability getExtended() {
    return () adaptersFactory.createAdapter(adaptee.getExtended(), eResource);
  }
  
  @Override
  public void setExtended(final org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapability o) {
    if (o != null)
    	adaptee.setExtended(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.interaction.AbstractCapabilityAdapter) o).getAdaptee());
    else adaptee.setExtended(null);
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapability getExtension() {
    return () adaptersFactory.createAdapter(adaptee.getExtension(), eResource);
  }
  
  @Override
  public void setExtension(final org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapability o) {
    if (o != null)
    	adaptee.setExtension(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.interaction.AbstractCapabilityAdapter) o).getAdaptee());
    else adaptee.setExtension(null);
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapabilityExtensionPoint getExtensionLocation() {
    return () adaptersFactory.createAdapter(adaptee.getExtensionLocation(), eResource);
  }
  
  @Override
  public void setExtensionLocation(final org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapabilityExtensionPoint o) {
    if (o != null)
    	adaptee.setExtensionLocation(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.interaction.AbstractCapabilityExtensionPointAdapter) o).getAdaptee());
    else adaptee.setExtensionLocation(null);
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.eINSTANCE.getAbstractCapabilityExtend();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__REALIZED_FLOW:
    		return getRealizedFlow();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__EXTENDED:
    		return getExtended();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__EXTENSION:
    		return getExtension();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__EXTENSION_LOCATION:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__EXTENSION_LOCATION:
    		return getExtensionLocation() != null;
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_EXTEND__EXTENSION_LOCATION:
    		...
    		(org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapabilityExtensionPoint)
    		 newValue);
    		return;
    }
