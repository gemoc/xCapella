...
public class PartDeploymentLinkAdapter extends EObjectAdapter<PartDeploymentLink> implements org.gemoc.scenario.xdsml.functionscenariomt.deployment.PartDeploymentLink {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public PartDeploymentLinkAdapter() {
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.eINSTANCE.getPartDeploymentLink();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__REALIZED_FLOW:
    		return getRealizedFlow();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__DEPLOYED_ELEMENT:
    		return getDeployedElement();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PART_DEPLOYMENT_LINK__LOCATION:
    		return getLocation();
    }
