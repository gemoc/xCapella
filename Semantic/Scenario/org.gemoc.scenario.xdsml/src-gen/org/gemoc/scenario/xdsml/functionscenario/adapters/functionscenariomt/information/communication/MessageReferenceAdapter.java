...
public class MessageReferenceAdapter extends EObjectAdapter<MessageReference> implements org.gemoc.scenario.xdsml.functionscenariomt.communication.MessageReference {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public MessageReferenceAdapter() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.communication.Message getMessage() {
    return () adaptersFactory.createAdapter(adaptee.getMessage(), eResource);
  }
  
  @Override
  public void setMessage(final org.gemoc.scenario.xdsml.functionscenariomt.communication.Message o) {
    if (o != null)
    	adaptee.setMessage(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.information.communication.MessageAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.eINSTANCE.getMessageReference();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__REALIZED_FLOW:
    		return getRealizedFlow();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__MESSAGE:
    		return getMessage();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.communication.CommunicationPackage.MESSAGE_REFERENCE__MESSAGE:
    		setMessage(
    		(org.gemoc.scenario.xdsml.functionscenariomt.communication.Message)
    		 newValue);
    		return;
    }
