...
public class ComponentPortAllocationEndAdapter extends EObjectAdapter<ComponentPortAllocationEnd> implements org.gemoc.scenario.xdsml.functionscenariomt.fa.ComponentPortAllocationEnd {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public ComponentPortAllocationEndAdapter() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.cs.Part getPart() {
    return () adaptersFactory.createAdapter(adaptee.getPart(), eResource);
  }
  
  @Override
  public void setPart(final org.gemoc.scenario.xdsml.functionscenariomt.cs.Part o) {
    if (o != null)
    	adaptee.setPart(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.cs.PartAdapter) o).getAdaptee());
    else adaptee.setPart(null);
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.fa.ComponentPortAllocation getOwningComponentPortAllocation() {
    return () adaptersFactory.createAdapter(adaptee.getOwningComponentPortAllocation(), eResource);
  }
  
  @Override
  public void setOwningComponentPortAllocation(final org.gemoc.scenario.xdsml.functionscenariomt.fa.ComponentPortAllocation o) {
    if (o != null)
    	adaptee.setOwningComponentPortAllocation(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.fa.ComponentPortAllocationAdapter) o).getAdaptee());
    else adaptee.setOwningComponentPortAllocation(null);
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.eINSTANCE.getComponentPortAllocationEnd();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__PORT:
    		return getPort();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__PART:
    		return getPart();
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNING_COMPONENT_PORT_ALLOCATION:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__PART:
    		setPart(
    		(org.gemoc.scenario.xdsml.functionscenariomt.cs.Part)
    		 newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNING_COMPONENT_PORT_ALLOCATION:
    		setOwningComponentPortAllocation(
    		(org.gemoc.scenario.xdsml.functionscenariomt.fa.ComponentPortAllocation)
    		 newValue);
    		return;
    }
    ...
    if (baseClass == org.gemoc.scenario.xdsml.functionscenariomt.modellingcore.PublishableElement.class) {
    	switch (baseFeatureID) {
    		case org.gemoc.scenario.xdsml.functionscenariomt.modellingcore.ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_DOC:
    			return org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__VISIBLE_IN_DOC;
    		case org.gemoc.scenario.xdsml.functionscenariomt.modellingcore.ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_LM:
    			return org.gemoc.scenario.xdsml.functionscenariomt.fa.FaPackage.COMPONENT_PORT_ALLOCATION_END__VISIBLE_IN_LM;
    		default: return -1;
    	}
    }
