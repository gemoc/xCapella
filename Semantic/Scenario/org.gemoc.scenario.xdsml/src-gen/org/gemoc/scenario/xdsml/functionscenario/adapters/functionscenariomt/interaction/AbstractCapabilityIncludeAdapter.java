...
public class AbstractCapabilityIncludeAdapter extends EObjectAdapter<AbstractCapabilityInclude> implements org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapabilityInclude {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public AbstractCapabilityIncludeAdapter() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapability getIncluded() {
    return () adaptersFactory.createAdapter(adaptee.getIncluded(), eResource);
  }
  
  @Override
  public void setIncluded(final org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapability o) {
    if (o != null)
    	adaptee.setIncluded(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.interaction.AbstractCapabilityAdapter) o).getAdaptee());
    else adaptee.setIncluded(null);
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapability getInclusion() {
    return () adaptersFactory.createAdapter(adaptee.getInclusion(), eResource);
  }
  
  @Override
  public void setInclusion(final org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractCapability o) {
    if (o != null)
    	adaptee.setInclusion(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.interaction.AbstractCapabilityAdapter) o).getAdaptee());
    else adaptee.setInclusion(null);
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.eINSTANCE.getAbstractCapabilityInclude();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__REALIZED_FLOW:
    		return getRealizedFlow();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__INCLUDED:
    		return getIncluded();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.ABSTRACT_CAPABILITY_INCLUDE__INCLUSION:
    		return getInclusion();
    }
