...
public class ConnectionInstanceAdapter extends EObjectAdapter<ConnectionInstance> implements org.gemoc.scenario.xdsml.functionscenariomt.deployment.ConnectionInstance {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public ConnectionInstanceAdapter() {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.deployment.PortInstance> */Object connectionEnds_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.deployment.PortInstance> */Object getConnectionEnds() {
    if (connectionEnds_ == null)
    	connectionEnds_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getConnectionEnds(), adaptersFactory, eResource);
    return connectionEnds_;
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.fa.ComponentExchange getType() {
    return () adaptersFactory.createAdapter(adaptee.getType(), eResource);
  }
  
  @Override
  public void setType(final org.gemoc.scenario.xdsml.functionscenariomt.fa.ComponentExchange o) {
    if (o != null)
    	adaptee.setType(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.fa.ComponentExchangeAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.eINSTANCE.getConnectionInstance();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__CONNECTION_ENDS:
    		return getConnectionEnds();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__TYPE:
    		return getType();
    }
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__CONNECTION_ENDS:
    		return getConnectionEnds() != null && !getConnectionEnds().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__TYPE:
    		return getType() != null;
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__CONNECTION_ENDS:
    		...
    		getConnectionEnds().addAll((Collection) newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.CONNECTION_INSTANCE__TYPE:
    		setType(
    		(org.gemoc.scenario.xdsml.functionscenariomt.fa.ComponentExchange)
    		 newValue);
    		return;
    }
