...
public class SystemFunctionAdapter extends EObjectAdapter<SystemFunction> implements org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemFunction {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public SystemFunctionAdapter() {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemFunctionPkg> */Object ownedSystemFunctionPkgs_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemFunctionPkg> */Object getOwnedSystemFunctionPkgs() {
    if (ownedSystemFunctionPkgs_ == null)
    	ownedSystemFunctionPkgs_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedSystemFunctionPkgs(), adaptersFactory, eResource);
    return ownedSystemFunctionPkgs_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Actor> */Object allocatorActors_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Actor> */Object getAllocatorActors() {
    if (allocatorActors_ == null)
    	allocatorActors_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getAllocatorActors(), adaptersFactory, eResource);
    return allocatorActors_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.System> */Object allocatorSystems_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.System> */Object getAllocatorSystems() {
    if (allocatorSystems_ == null)
    	allocatorSystems_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getAllocatorSystems(), adaptersFactory, eResource);
    return allocatorSystems_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.oa.OperationalActivity> */Object realizedOperationalActivities_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.oa.OperationalActivity> */Object getRealizedOperationalActivities() {
    if (realizedOperationalActivities_ == null)
    	realizedOperationalActivities_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getRealizedOperationalActivities(), adaptersFactory, eResource);
    return realizedOperationalActivities_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.la.LogicalFunction> */Object realizingLogicalFunctions_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.la.LogicalFunction> */Object getRealizingLogicalFunctions() {
    if (realizingLogicalFunctions_ == null)
    	realizingLogicalFunctions_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getRealizingLogicalFunctions(), adaptersFactory, eResource);
    return realizingLogicalFunctions_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemFunction> */Object containedSystemFunctions_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemFunction> */Object getContainedSystemFunctions() {
    if (containedSystemFunctions_ == null)
    	containedSystemFunctions_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getContainedSystemFunctions(), adaptersFactory, eResource);
    return containedSystemFunctions_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemFunction> */Object childrenSystemFunctions_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemFunction> */Object getChildrenSystemFunctions() {
    if (childrenSystemFunctions_ == null)
    	childrenSystemFunctions_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getChildrenSystemFunctions(), adaptersFactory, eResource);
    return childrenSystemFunctions_;
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.eINSTANCE.getSystemFunction();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_TRACES:
    		return getOwnedTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__CONTAINED_GENERIC_TRACES:
    		return getContainedGenericTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__CONTAINED_REQUIREMENTS_TRACES:
    		return getContainedRequirementsTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__NAMING_RULES:
    		return getNamingRules();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__INVOLVING_INVOLVEMENTS:
    		return getInvolvingInvolvements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__IS_ABSTRACT:
    		return isIsAbstract() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__IS_STATIC:
    		return isIsStatic() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__VISIBILITY:
    		return getVisibility();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__ABSTRACT_TYPE:
    		return getAbstractType();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__TYPE:
    		return getType();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__ORDERED:
    		return isOrdered() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__UNIQUE:
    		return isUnique() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__MIN_INCLUSIVE:
    		return isMinInclusive() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__MAX_INCLUSIVE:
    		return isMaxInclusive() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_DEFAULT_VALUE:
    		return getOwnedDefaultValue();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_MIN_VALUE:
    		return getOwnedMinValue();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_MAX_VALUE:
    		return getOwnedMaxValue();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_NULL_VALUE:
    		return getOwnedNullValue();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_MIN_CARD:
    		return getOwnedMinCard();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_MIN_LENGTH:
    		return getOwnedMinLength();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_MAX_CARD:
    		return getOwnedMaxCard();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_MAX_LENGTH:
    		return getOwnedMaxLength();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__FINAL:
    		return isFinal() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__AGGREGATION_KIND:
    		return getAggregationKind();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__IS_DERIVED:
    		return isIsDerived() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__IS_READ_ONLY:
    		return isIsReadOnly() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__IS_PART_OF_KEY:
    		return isIsPartOfKey() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__ASSOCIATION:
    		return getAssociation();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__REPRESENTING_INSTANCE_ROLES:
    		return getRepresentingInstanceRoles();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_FUNCTIONAL_CHAINS:
    		return getOwnedFunctionalChains();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__IN_ACTIVITY_PARTITION:
    		return getInActivityPartition();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__IN_INTERRUPTIBLE_REGION:
    		return getInInterruptibleRegion();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__IN_STRUCTURED_NODE:
    		return getInStructuredNode();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OUTGOING:
    		return getOutgoing();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__INCOMING:
    		return getIncoming();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_HANDLERS:
    		return getOwnedHandlers();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__LOCAL_PRECONDITION:
    		return getLocalPrecondition();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__LOCAL_POSTCONDITION:
    		return getLocalPostcondition();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__CONTEXT:
    		return getContext();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__INPUTS:
    		return getInputs();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OUTPUTS:
    		return getOutputs();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__ARGUMENTS:
    		return getArguments();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__RESULTS:
    		return getResults();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__BEHAVIOR:
    		return getBehavior();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__ABSTRACT_TYPED_ELEMENTS:
    		return getAbstractTypedElements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__KIND:
    		return getKind();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__CONDITION:
    		return getCondition();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_FUNCTIONS:
    		return getOwnedFunctions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_FUNCTION_REALIZATIONS:
    		return getOwnedFunctionRealizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_FUNCTIONAL_EXCHANGES:
    		return getOwnedFunctionalExchanges();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__SUB_FUNCTIONS:
    		return getSubFunctions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OUT_FUNCTION_REALIZATIONS:
    		return getOutFunctionRealizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__IN_FUNCTION_REALIZATIONS:
    		return getInFunctionRealizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__COMPONENT_FUNCTIONAL_ALLOCATIONS:
    		return getComponentFunctionalAllocations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__ALLOCATION_BLOCKS:
    		return getAllocationBlocks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__AVAILABLE_IN_STATES:
    		return getAvailableInStates();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__INVOLVING_CAPABILITIES:
    		return getInvolvingCapabilities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__INVOLVING_CAPABILITY_REALIZATIONS:
    		return getInvolvingCapabilityRealizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__INVOLVING_FUNCTIONAL_CHAINS:
    		return getInvolvingFunctionalChains();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__LINKED_STATE_MACHINE:
    		return getLinkedStateMachine();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__LINKED_FUNCTION_SPECIFICATION:
    		return getLinkedFunctionSpecification();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_SYSTEM_FUNCTION_PKGS:
    		return getOwnedSystemFunctionPkgs();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__ALLOCATOR_ACTORS:
    		return getAllocatorActors();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__ALLOCATOR_SYSTEMS:
    		return getAllocatorSystems();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__REALIZED_OPERATIONAL_ACTIVITIES:
    		return getRealizedOperationalActivities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__REALIZING_LOGICAL_FUNCTIONS:
    		return getRealizingLogicalFunctions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__CONTAINED_SYSTEM_FUNCTIONS:
    		return getContainedSystemFunctions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__CHILDREN_SYSTEM_FUNCTIONS:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_SYSTEM_FUNCTION_PKGS:
    		return getOwnedSystemFunctionPkgs() != null && !getOwnedSystemFunctionPkgs().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__ALLOCATOR_ACTORS:
    		return getAllocatorActors() != null && !getAllocatorActors().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__ALLOCATOR_SYSTEMS:
    		return getAllocatorSystems() != null && !getAllocatorSystems().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__REALIZED_OPERATIONAL_ACTIVITIES:
    		return getRealizedOperationalActivities() != null && !getRealizedOperationalActivities().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__REALIZING_LOGICAL_FUNCTIONS:
    		return getRealizingLogicalFunctions() != null && !getRealizingLogicalFunctions().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__CONTAINED_SYSTEM_FUNCTIONS:
    		return getContainedSystemFunctions() != null && !getContainedSystemFunctions().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__CHILDREN_SYSTEM_FUNCTIONS:
    		return getChildrenSystemFunctions() != null && !getChildrenSystemFunctions().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_FUNCTION__OWNED_SYSTEM_FUNCTION_PKGS:
    		...
    		getOwnedSystemFunctionPkgs().addAll((Collection) newValue);
    		return;
    }
