...
public class PortInstanceAdapter extends EObjectAdapter<PortInstance> implements org.gemoc.scenario.xdsml.functionscenariomt.deployment.PortInstance {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public PortInstanceAdapter() {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.deployment.ConnectionInstance> */Object connections_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.deployment.ConnectionInstance> */Object getConnections() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.deployment.ComponentInstance getComponent() {
    return () adaptersFactory.createAdapter(adaptee.getComponent(), eResource);
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.fa.ComponentPort getType() {
    return () adaptersFactory.createAdapter(adaptee.getType(), eResource);
  }
  
  @Override
  public void setType(final org.gemoc.scenario.xdsml.functionscenariomt.fa.ComponentPort o) {
    if (o != null)
    	adaptee.setType(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.fa.ComponentPortAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.eINSTANCE.getPortInstance();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__CONNECTIONS:
    		return getConnections();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__COMPONENT:
    		return getComponent();
    	case org.gemoc.scenario.xdsml.functionscenariomt.deployment.DeploymentPackage.PORT_INSTANCE__TYPE:
    		return getType();
    }
