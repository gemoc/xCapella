...
public class SystemCapabilityInvolvementAdapter extends EObjectAdapter<SystemCapabilityInvolvement> implements org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCapabilityInvolvement {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public SystemCapabilityInvolvementAdapter() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.ctx.Capability getCapability() {
    return () adaptersFactory.createAdapter(adaptee.getCapability(), eResource);
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.ctx.System getSystem() {
    return () adaptersFactory.createAdapter(adaptee.getSystem(), eResource);
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.eINSTANCE.getSystemCapabilityInvolvement();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__REALIZED_FLOW:
    		return getRealizedFlow();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__INVOLVER:
    		return getInvolver();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__INVOLVED:
    		return getInvolved();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__CAPABILITY:
    		return getCapability();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_CAPABILITY_INVOLVEMENT__SYSTEM:
    		return getSystem();
    }
