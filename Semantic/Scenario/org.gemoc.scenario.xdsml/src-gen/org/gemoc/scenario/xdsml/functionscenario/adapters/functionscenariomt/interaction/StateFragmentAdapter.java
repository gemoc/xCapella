...
public class StateFragmentAdapter extends EObjectAdapter<StateFragment> implements org.gemoc.scenario.xdsml.functionscenariomt.interaction.StateFragment {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public StateFragmentAdapter() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.AbstractState getRelatedAbstractState() {
    return () adaptersFactory.createAdapter(adaptee.getRelatedAbstractState(), eResource);
  }
  
  @Override
  public void setRelatedAbstractState(final org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.AbstractState o) {
    if (o != null)
    	adaptee.setRelatedAbstractState(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.capellacommon.AbstractStateAdapter) o).getAdaptee());
    else adaptee.setRelatedAbstractState(null);
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.fa.AbstractFunction getRelatedAbstractFunction() {
    return () adaptersFactory.createAdapter(adaptee.getRelatedAbstractFunction(), eResource);
  }
  
  @Override
  public void setRelatedAbstractFunction(final org.gemoc.scenario.xdsml.functionscenariomt.fa.AbstractFunction o) {
    if (o != null)
    	adaptee.setRelatedAbstractFunction(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.fa.AbstractFunctionAdapter) o).getAdaptee());
    else adaptee.setRelatedAbstractFunction(null);
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.eINSTANCE.getStateFragment();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__START:
    		return getStart();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__FINISH:
    		return getFinish();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__RELATED_ABSTRACT_STATE:
    		return getRelatedAbstractState();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__RELATED_ABSTRACT_FUNCTION:
    		return getRelatedAbstractFunction();
    }
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__RELATED_ABSTRACT_STATE:
    		return getRelatedAbstractState() != null;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__RELATED_ABSTRACT_FUNCTION:
    		return getRelatedAbstractFunction() != null;
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__FINISH:
    		...
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__RELATED_ABSTRACT_STATE:
    		setRelatedAbstractState(
    		(org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.AbstractState)
    		 newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.STATE_FRAGMENT__RELATED_ABSTRACT_FUNCTION:
    		setRelatedAbstractFunction(
    		(org.gemoc.scenario.xdsml.functionscenariomt.fa.AbstractFunction)
    		 newValue);
    		return;
    }
