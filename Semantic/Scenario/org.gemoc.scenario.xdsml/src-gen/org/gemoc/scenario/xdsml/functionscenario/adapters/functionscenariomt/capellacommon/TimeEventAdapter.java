...
public class TimeEventAdapter extends EObjectAdapter<TimeEvent> implements org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.TimeEvent {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.TimeEventKind getKind() {
    return org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.TimeEventKind.get(adaptee.getKind().getValue());
  }
  
  @Override
  public void setKind(final org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.TimeEventKind o) {
    adaptee.setKind(org.polarsys.capella.core.data.capellacommon.TimeEventKind.get(o.getValue()));
  }
  ...
  @Override
  public void setTime(final String o) {
    adaptee.setTime(o);
  }
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.capellacore.Constraint getCondition() {
    return () adaptersFactory.createAdapter(adaptee.getCondition(), eResource);
  }
  
  @Override
  public void setCondition(final org.gemoc.scenario.xdsml.functionscenariomt.capellacore.Constraint o) {
    if (o != null)
    	adaptee.setCondition(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.capellacore.ConstraintAdapter) o).getAdaptee());
    else adaptee.setCondition(null);
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.StateEventRealization> */Object ownedStateEventRealizations_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.StateEventRealization> */Object getOwnedStateEventRealizations() {
    if (ownedStateEventRealizations_ == null)
    	ownedStateEventRealizations_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedStateEventRealizations(), adaptersFactory, eResource);
    return ownedStateEventRealizations_;
  }
  ...
  protected final static org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.TimeEventKind KIND_EDEFAULT = org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.TimeEventKind.AT;
  
  protected final static String TIME_EDEFAULT = null;
  
  @Override
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.eINSTANCE.getTimeEvent();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__ABSTRACT_TYPED_ELEMENTS:
    		return getAbstractTypedElements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__CONDITION:
    		return getCondition();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__OWNED_STATE_EVENT_REALIZATIONS:
    		return getOwnedStateEventRealizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__KIND:
    		return getKind();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__TIME:
    		return getTime();
    }
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__OWNED_STATE_EVENT_REALIZATIONS:
    		return getOwnedStateEventRealizations() != null && !getOwnedStateEventRealizations().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__KIND:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__OWNED_STATE_EVENT_REALIZATIONS:
    		...
    		getOwnedStateEventRealizations().addAll((Collection) newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__KIND:
    		setKind(
    		(org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.TimeEventKind)
    		 newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.TIME_EVENT__TIME:
    		setTime(
