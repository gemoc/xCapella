...
public class OutputPinAdapter extends EObjectAdapter<OutputPin> implements org.gemoc.scenario.xdsml.functionscenariomt.activity.OutputPin {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public OutputPinAdapter() {
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.eINSTANCE.getOutputPin();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__IN_ACTIVITY_PARTITION:
    		return getInActivityPartition();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__IN_INTERRUPTIBLE_REGION:
    		return getInInterruptibleRegion();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__IN_STRUCTURED_NODE:
    		return getInStructuredNode();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__OUTGOING:
    		return getOutgoing();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__INCOMING:
    		return getIncoming();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__ABSTRACT_TYPE:
    		return getAbstractType();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__IS_CONTROL_TYPE:
    		return isIsControlType() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__KIND_OF_NODE:
    		return getKindOfNode();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__ORDERING:
    		return getOrdering();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__UPPER_BOUND:
    		return getUpperBound();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__IN_STATE:
    		return getInState();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__SELECTION:
    		return getSelection();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.OUTPUT_PIN__IS_CONTROL:
