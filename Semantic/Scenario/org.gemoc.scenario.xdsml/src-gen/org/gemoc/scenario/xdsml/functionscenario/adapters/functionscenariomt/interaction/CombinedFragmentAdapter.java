...
public class CombinedFragmentAdapter extends EObjectAdapter<CombinedFragment> implements org.gemoc.scenario.xdsml.functionscenariomt.interaction.CombinedFragment {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public CombinedFragmentAdapter() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionOperatorKind getOperator() {
    return org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionOperatorKind.get(adaptee.getOperator().getValue());
  }
  
  @Override
  public void setOperator(final org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionOperatorKind o) {
    adaptee.setOperator(org.polarsys.capella.core.data.interaction.InteractionOperatorKind.get(o.getValue()));
  }
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionFragment getStart() {
    return () adaptersFactory.createAdapter(adaptee.getStart(), eResource);
  }
  
  @Override
  public void setStart(final org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionFragment o) {
    if (o != null)
    	adaptee.setStart(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.interaction.InteractionFragmentAdapter) o).getAdaptee());
    else adaptee.setStart(null);
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionFragment getFinish() {
    return () adaptersFactory.createAdapter(adaptee.getFinish(), eResource);
  }
  
  @Override
  public void setFinish(final org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionFragment o) {
    if (o != null)
    	adaptee.setFinish(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.interaction.InteractionFragmentAdapter) o).getAdaptee());
    else adaptee.setFinish(null);
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.interaction.Gate> */Object ownedGates_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.interaction.Gate> */Object getOwnedGates() {
    if (ownedGates_ == null)
    	ownedGates_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedGates(), adaptersFactory, eResource);
    return ownedGates_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionOperand> */Object referencedOperands_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionOperand> */Object getReferencedOperands() {
    if (referencedOperands_ == null)
    	referencedOperands_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getReferencedOperands(), adaptersFactory, eResource);
    return referencedOperands_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.interaction.Gate> */Object expressionGates_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.interaction.Gate> */Object getExpressionGates() {
    if (expressionGates_ == null)
    	expressionGates_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getExpressionGates(), adaptersFactory, eResource);
    return expressionGates_;
  }
  ...
  protected final static org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionOperatorKind OPERATOR_EDEFAULT = org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionOperatorKind.UNSET;
  
  @Override
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.eINSTANCE.getCombinedFragment();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__START:
    		return getStart();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__FINISH:
    		return getFinish();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__OWNED_GATES:
    		return getOwnedGates();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__OPERATOR:
    		return getOperator();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__REFERENCED_OPERANDS:
    		return getReferencedOperands();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__EXPRESSION_GATES:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__OWNED_GATES:
    		return getOwnedGates() != null && !getOwnedGates().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__OPERATOR:
    		return getOperator() != OPERATOR_EDEFAULT;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__REFERENCED_OPERANDS:
    		return getReferencedOperands() != null && !getReferencedOperands().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__EXPRESSION_GATES:
    		return getExpressionGates() != null && !getExpressionGates().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__START:
    		setStart(
    		(org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionFragment)
    		 newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__FINISH:
    		setFinish(
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__OWNED_GATES:
    		getOwnedGates().clear();
    		getOwnedGates().addAll((Collection) newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__OPERATOR:
    		setOperator(
    		(org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionOperatorKind)
    		 newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.COMBINED_FRAGMENT__REFERENCED_OPERANDS:
    		getReferencedOperands().clear();
    		getReferencedOperands().addAll((Collection) newValue);
    		return;
    }
