...
public class ControlFlowAdapter extends EObjectAdapter<ControlFlow> implements org.gemoc.scenario.xdsml.functionscenariomt.activity.ControlFlow {
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.eINSTANCE.getControlFlow();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__REALIZED_FLOW:
    		return getRealizedFlow();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__KIND_OF_RATE:
    		return getKindOfRate();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__IN_ACTIVITY_PARTITION:
    		return getInActivityPartition();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__IN_INTERRUPTIBLE_REGION:
    		return getInInterruptibleRegion();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__IN_STRUCTURED_NODE:
    		return getInStructuredNode();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__RATE:
    		return getRate();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__PROBABILITY:
    		return getProbability();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__TARGET:
    		return getTarget();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__SOURCE:
    		return getSource();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__GUARD:
    		return getGuard();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__WEIGHT:
    		return getWeight();
    	case org.gemoc.scenario.xdsml.functionscenariomt.activity.ActivityPackage.CONTROL_FLOW__INTERRUPTS:
