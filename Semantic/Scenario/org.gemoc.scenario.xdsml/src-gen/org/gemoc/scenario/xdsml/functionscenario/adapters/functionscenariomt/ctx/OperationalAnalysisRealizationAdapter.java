...
public class OperationalAnalysisRealizationAdapter extends EObjectAdapter<OperationalAnalysisRealization> implements org.gemoc.scenario.xdsml.functionscenariomt.ctx.OperationalAnalysisRealization {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public OperationalAnalysisRealizationAdapter() {
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.eINSTANCE.getOperationalAnalysisRealization();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__REALIZED_FLOW:
    		return getRealizedFlow();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__TARGET_ELEMENT:
    		return getTargetElement();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__SOURCE_ELEMENT:
    		return getSourceElement();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__ALLOCATED_ARCHITECTURE:
    		return getAllocatedArchitecture();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.OPERATIONAL_ANALYSIS_REALIZATION__ALLOCATING_ARCHITECTURE:
