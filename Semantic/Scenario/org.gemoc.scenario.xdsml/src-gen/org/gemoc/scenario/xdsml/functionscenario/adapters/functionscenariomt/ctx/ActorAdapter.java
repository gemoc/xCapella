...
public class ActorAdapter extends EObjectAdapter<Actor> implements org.gemoc.scenario.xdsml.functionscenariomt.ctx.Actor {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.ActorMissionInvolvement> */Object participationsInMissions_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.ActorMissionInvolvement> */Object getParticipationsInMissions() {
    if (participationsInMissions_ == null)
    	participationsInMissions_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getParticipationsInMissions(), adaptersFactory, eResource);
    return participationsInMissions_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.ActorCapabilityInvolvement> */Object participationsInCapabilities_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.ActorCapabilityInvolvement> */Object getParticipationsInCapabilities() {
    if (participationsInCapabilities_ == null)
    	participationsInCapabilities_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getParticipationsInCapabilities(), adaptersFactory, eResource);
    return participationsInCapabilities_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.cs.ActorCapabilityRealizationInvolvement> */Object participationsInCapabilityRealizations_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.cs.ActorCapabilityRealizationInvolvement> */Object getParticipationsInCapabilityRealizations() {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Mission> */Object contributedMissions_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Mission> */Object getContributedMissions() {
    if (contributedMissions_ == null)
    	contributedMissions_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getContributedMissions(), adaptersFactory, eResource);
    return contributedMissions_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Capability> */Object contributedCapabilities_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Capability> */Object getContributedCapabilities() {
    if (contributedCapabilities_ == null)
    	contributedCapabilities_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getContributedCapabilities(), adaptersFactory, eResource);
    return contributedCapabilities_;
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCommunicationHook getSystemCommunication() {
    return () adaptersFactory.createAdapter(adaptee.getSystemCommunication(), eResource);
  }
  
  @Override
  public void setSystemCommunication(final org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCommunicationHook o) {
    if (o != null)
    	adaptee.setSystemCommunication(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.ctx.SystemCommunicationHookAdapter) o).getAdaptee());
    else adaptee.setSystemCommunication(null);
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.OperationalActorRealization> */Object ownedOperationalActorRealizations_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.OperationalActorRealization> */Object getOwnedOperationalActorRealizations() {
    if (ownedOperationalActorRealizations_ == null)
    	ownedOperationalActorRealizations_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedOperationalActorRealizations(), adaptersFactory, eResource);
    return ownedOperationalActorRealizations_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.OperationalEntityRealization> */Object ownedOperationalEntityRealizations_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.OperationalEntityRealization> */Object getOwnedOperationalEntityRealizations() {
    if (ownedOperationalEntityRealizations_ == null)
    	ownedOperationalEntityRealizations_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedOperationalEntityRealizations(), adaptersFactory, eResource);
    return ownedOperationalEntityRealizations_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemFunction> */Object allocatedSystemFunctions_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemFunction> */Object getAllocatedSystemFunctions() {
    if (allocatedSystemFunctions_ == null)
    	allocatedSystemFunctions_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getAllocatedSystemFunctions(), adaptersFactory, eResource);
    return allocatedSystemFunctions_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.oa.Entity> */Object realizedEntities_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.oa.Entity> */Object getRealizedEntities() {
    if (realizedEntities_ == null)
    	realizedEntities_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getRealizedEntities(), adaptersFactory, eResource);
    return realizedEntities_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.oa.OperationalActor> */Object realizedOperationalActors_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.oa.OperationalActor> */Object getRealizedOperationalActors() {
    if (realizedOperationalActors_ == null)
    	realizedOperationalActors_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getRealizedOperationalActors(), adaptersFactory, eResource);
    return realizedOperationalActors_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.la.LogicalActor> */Object realizingLogicalActors_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.la.LogicalActor> */Object getRealizingLogicalActors() {
    if (realizingLogicalActors_ == null)
    	realizingLogicalActors_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getRealizingLogicalActors(), adaptersFactory, eResource);
    return realizingLogicalActors_;
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.eINSTANCE.getActor();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__ABSTRACT_TYPED_ELEMENTS:
    		return getAbstractTypedElements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_TRACES:
    		return getOwnedTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__CONTAINED_GENERIC_TRACES:
    		return getContainedGenericTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__CONTAINED_REQUIREMENTS_TRACES:
    		return getContainedRequirementsTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__NAMING_RULES:
    		return getNamingRules();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__TYPED_ELEMENTS:
    		return getTypedElements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_FUNCTIONAL_ALLOCATION:
    		return getOwnedFunctionalAllocation();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_COMPONENT_EXCHANGES:
    		return getOwnedComponentExchanges();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_COMPONENT_EXCHANGE_CATEGORIES:
    		return getOwnedComponentExchangeCategories();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__FUNCTIONAL_ALLOCATIONS:
    		return getFunctionalAllocations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__ALLOCATED_FUNCTIONS:
    		return getAllocatedFunctions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__IN_EXCHANGE_LINKS:
    		return getInExchangeLinks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OUT_EXCHANGE_LINKS:
    		return getOutExchangeLinks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_ABSTRACT_CAPABILITY_PKG:
    		return getOwnedAbstractCapabilityPkg();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_INTERFACE_PKG:
    		return getOwnedInterfacePkg();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_DATA_PKG:
    		return getOwnedDataPkg();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_STATE_MACHINES:
    		return getOwnedStateMachines();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__ABSTRACT:
    		return isAbstract() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_GENERALIZATIONS:
    		return getOwnedGeneralizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__SUPER_GENERALIZATIONS:
    		return getSuperGeneralizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__SUB_GENERALIZATIONS:
    		return getSubGeneralizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__SUPER:
    		return getSuper();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__SUB:
    		return getSub();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_FEATURES:
    		return getOwnedFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__CONTAINED_PROPERTIES:
    		return getContainedProperties();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_PARTITIONS:
    		return getOwnedPartitions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__REPRESENTING_PARTITIONS:
    		return getRepresentingPartitions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_INTERFACE_ALLOCATIONS:
    		return getOwnedInterfaceAllocations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__PROVISIONED_INTERFACE_ALLOCATIONS:
    		return getProvisionedInterfaceAllocations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__ALLOCATED_INTERFACES:
    		return getAllocatedInterfaces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_COMMUNICATION_LINKS:
    		return getOwnedCommunicationLinks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__PRODUCE:
    		return getProduce();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__CONSUME:
    		return getConsume();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__SEND:
    		return getSend();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__RECEIVE:
    		return getReceive();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__CALL:
    		return getCall();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__EXECUTE:
    		return getExecute();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__WRITE:
    		return getWrite();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__ACCESS:
    		return getAccess();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__ACQUIRE:
    		return getAcquire();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__TRANSMIT:
    		return getTransmit();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_INTERFACE_USES:
    		return getOwnedInterfaceUses();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__USED_INTERFACE_LINKS:
    		return getUsedInterfaceLinks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__USED_INTERFACES:
    		return getUsedInterfaces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_INTERFACE_IMPLEMENTATIONS:
    		return getOwnedInterfaceImplementations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__IMPLEMENTED_INTERFACE_LINKS:
    		return getImplementedInterfaceLinks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__IMPLEMENTED_INTERFACES:
    		return getImplementedInterfaces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__PROVISIONED_COMPONENT_ALLOCATIONS:
    		return getProvisionedComponentAllocations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__PROVISIONING_COMPONENT_ALLOCATIONS:
    		return getProvisioningComponentAllocations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__ALLOCATED_COMPONENTS:
    		return getAllocatedComponents();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__ALLOCATING_COMPONENTS:
    		return getAllocatingComponents();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__PROVIDED_INTERFACES:
    		return getProvidedInterfaces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__REQUIRED_INTERFACES:
    		return getRequiredInterfaces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__CONTAINED_COMPONENT_PORTS:
    		return getContainedComponentPorts();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__CONTAINED_PARTS:
    		return getContainedParts();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__CONTAINED_PHYSICAL_PORTS:
    		return getContainedPhysicalPorts();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_PHYSICAL_PATH:
    		return getOwnedPhysicalPath();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_PHYSICAL_LINKS:
    		return getOwnedPhysicalLinks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_PHYSICAL_LINK_CATEGORIES:
    		return getOwnedPhysicalLinkCategories();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__INVOLVING_INVOLVEMENTS:
    		return getInvolvingInvolvements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__INVOLVING_CAPABILITY_REALIZATION_INVOLVEMENTS:
    		return getInvolvingCapabilityRealizationInvolvements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__PARTICIPATIONS_IN_MISSIONS:
    		return getParticipationsInMissions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__PARTICIPATIONS_IN_CAPABILITIES:
    		return getParticipationsInCapabilities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__PARTICIPATIONS_IN_CAPABILITY_REALIZATIONS:
    		return getParticipationsInCapabilityRealizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__CONTRIBUTED_MISSIONS:
    		return getContributedMissions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__CONTRIBUTED_CAPABILITIES:
    		return getContributedCapabilities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__SYSTEM_COMMUNICATION:
    		return getSystemCommunication();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_OPERATIONAL_ACTOR_REALIZATIONS:
    		return getOwnedOperationalActorRealizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_OPERATIONAL_ENTITY_REALIZATIONS:
    		return getOwnedOperationalEntityRealizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__ALLOCATED_SYSTEM_FUNCTIONS:
    		return getAllocatedSystemFunctions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__REALIZED_ENTITIES:
    		return getRealizedEntities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__REALIZED_OPERATIONAL_ACTORS:
    		return getRealizedOperationalActors();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__REALIZING_LOGICAL_ACTORS:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__PARTICIPATIONS_IN_MISSIONS:
    		return getParticipationsInMissions() != null && !getParticipationsInMissions().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__PARTICIPATIONS_IN_CAPABILITIES:
    		return getParticipationsInCapabilities() != null && !getParticipationsInCapabilities().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__PARTICIPATIONS_IN_CAPABILITY_REALIZATIONS:
    		return getParticipationsInCapabilityRealizations() != null && !getParticipationsInCapabilityRealizations().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__CONTRIBUTED_MISSIONS:
    		return getContributedMissions() != null && !getContributedMissions().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__CONTRIBUTED_CAPABILITIES:
    		return getContributedCapabilities() != null && !getContributedCapabilities().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__SYSTEM_COMMUNICATION:
    		return getSystemCommunication() != null;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_OPERATIONAL_ACTOR_REALIZATIONS:
    		return getOwnedOperationalActorRealizations() != null && !getOwnedOperationalActorRealizations().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_OPERATIONAL_ENTITY_REALIZATIONS:
    		return getOwnedOperationalEntityRealizations() != null && !getOwnedOperationalEntityRealizations().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__ALLOCATED_SYSTEM_FUNCTIONS:
    		return getAllocatedSystemFunctions() != null && !getAllocatedSystemFunctions().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__REALIZED_ENTITIES:
    		return getRealizedEntities() != null && !getRealizedEntities().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__REALIZED_OPERATIONAL_ACTORS:
    		return getRealizedOperationalActors() != null && !getRealizedOperationalActors().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__REALIZING_LOGICAL_ACTORS:
    		return getRealizingLogicalActors() != null && !getRealizingLogicalActors().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_PHYSICAL_LINK_CATEGORIES:
    		...
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__SYSTEM_COMMUNICATION:
    		setSystemCommunication(
    		(org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCommunicationHook)
    		 newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_OPERATIONAL_ACTOR_REALIZATIONS:
    		getOwnedOperationalActorRealizations().clear();
    		getOwnedOperationalActorRealizations().addAll((Collection) newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.ACTOR__OWNED_OPERATIONAL_ENTITY_REALIZATIONS:
    		getOwnedOperationalEntityRealizations().clear();
    		getOwnedOperationalEntityRealizations().addAll((Collection) newValue);
    		return;
    }
