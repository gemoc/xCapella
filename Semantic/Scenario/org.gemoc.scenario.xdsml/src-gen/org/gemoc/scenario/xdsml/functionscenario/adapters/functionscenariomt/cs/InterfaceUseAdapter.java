...
public class InterfaceUseAdapter extends EObjectAdapter<InterfaceUse> implements org.gemoc.scenario.xdsml.functionscenariomt.cs.InterfaceUse {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public InterfaceUseAdapter() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.cs.Component getInterfaceUser() {
    return () adaptersFactory.createAdapter(adaptee.getInterfaceUser(), eResource);
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.cs.Interface getUsedInterface() {
    return () adaptersFactory.createAdapter(adaptee.getUsedInterface(), eResource);
  }
  
  @Override
  public void setUsedInterface(final org.gemoc.scenario.xdsml.functionscenariomt.cs.Interface o) {
    if (o != null)
    	adaptee.setUsedInterface(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.cs.InterfaceAdapter) o).getAdaptee());
    else adaptee.setUsedInterface(null);
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.eINSTANCE.getInterfaceUse();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__REALIZED_FLOW:
    		return getRealizedFlow();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__INTERFACE_USER:
    		return getInterfaceUser();
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__USED_INTERFACE:
    		return getUsedInterface();
    }
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__INTERFACE_USER:
    		return getInterfaceUser() != null;
    	case org.gemoc.scenario.xdsml.functionscenariomt.cs.CsPackage.INTERFACE_USE__USED_INTERFACE:
    		return getUsedInterface() != null;
    }
