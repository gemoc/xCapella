...
public class AbstractSignalEventAdapter extends EObjectAdapter<AbstractSignalEvent> implements org.gemoc.scenario.xdsml.functionscenariomt.behavior.AbstractSignalEvent {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public AbstractSignalEventAdapter() {
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.behavior.BehaviorPackage.eINSTANCE.getAbstractSignalEvent();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.behavior.BehaviorPackage.ABSTRACT_SIGNAL_EVENT__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.behavior.BehaviorPackage.ABSTRACT_SIGNAL_EVENT__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.behavior.BehaviorPackage.ABSTRACT_SIGNAL_EVENT__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.behavior.BehaviorPackage.ABSTRACT_SIGNAL_EVENT__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.behavior.BehaviorPackage.ABSTRACT_SIGNAL_EVENT__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.behavior.BehaviorPackage.ABSTRACT_SIGNAL_EVENT__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.behavior.BehaviorPackage.ABSTRACT_SIGNAL_EVENT__ABSTRACT_TYPED_ELEMENTS:
    		return getAbstractTypedElements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.behavior.BehaviorPackage.ABSTRACT_SIGNAL_EVENT__SIGNAL:
    		return getSignal();
    }
