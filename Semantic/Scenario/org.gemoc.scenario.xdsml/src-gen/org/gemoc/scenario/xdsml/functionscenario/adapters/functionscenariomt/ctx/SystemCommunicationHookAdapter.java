...
public class SystemCommunicationHookAdapter extends EObjectAdapter<SystemCommunicationHook> implements org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCommunicationHook {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public SystemCommunicationHookAdapter() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCommunication getCommunication() {
    return () adaptersFactory.createAdapter(adaptee.getCommunication(), eResource);
  }
  
  @Override
  public void setCommunication(final org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCommunication o) {
    if (o != null)
    	adaptee.setCommunication(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.ctx.SystemCommunicationAdapter) o).getAdaptee());
    else adaptee.setCommunication(null);
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.cs.Component getType() {
    return () adaptersFactory.createAdapter(adaptee.getType(), eResource);
  }
  
  @Override
  public void setType(final org.gemoc.scenario.xdsml.functionscenariomt.cs.Component o) {
    if (o != null)
    	adaptee.setType(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.cs.ComponentAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.eINSTANCE.getSystemCommunicationHook();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__COMMUNICATION:
    		return getCommunication();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__TYPE:
    		return getType();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__COMMUNICATION:
    		setCommunication(
    		(org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCommunication)
    		 newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM_COMMUNICATION_HOOK__TYPE:
    		setType(
    		(org.gemoc.scenario.xdsml.functionscenariomt.cs.Component)
    		 newValue);
    		return;
    }
