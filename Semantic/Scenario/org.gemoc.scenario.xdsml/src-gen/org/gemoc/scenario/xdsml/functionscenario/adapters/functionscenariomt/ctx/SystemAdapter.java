...
public class SystemAdapter extends EObjectAdapter<org.polarsys.capella.core.data.ctx.System> implements org.gemoc.scenario.xdsml.functionscenariomt.ctx.System {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCapabilityInvolvement> */Object participationsInCapabilities_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCapabilityInvolvement> */Object getParticipationsInCapabilities() {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemMissionInvolvement> */Object participationsInMissions_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemMissionInvolvement> */Object getParticipationsInMissions() {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCommunicationHook> */Object externalCommunication_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCommunicationHook> */Object getExternalCommunication() {
    if (externalCommunication_ == null)
    	externalCommunication_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getExternalCommunication(), adaptersFactory, eResource);
    return externalCommunication_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.OperationalEntityRealization> */Object ownedEntityRealizations_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.OperationalEntityRealization> */Object getOwnedEntityRealizations() {
    if (ownedEntityRealizations_ == null)
    	ownedEntityRealizations_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedEntityRealizations(), adaptersFactory, eResource);
    return ownedEntityRealizations_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.OperationalEntityRealization> */Object allocatedEntityRealizations_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.OperationalEntityRealization> */Object getAllocatedEntityRealizations() {
    if (allocatedEntityRealizations_ == null)
    	allocatedEntityRealizations_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getAllocatedEntityRealizations(), adaptersFactory, eResource);
    return allocatedEntityRealizations_;
  }
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.la.LogicalComponent> */Object realizingLogicalComponents_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.la.LogicalComponent> */Object getRealizingLogicalComponents() {
    if (realizingLogicalComponents_ == null)
    	realizingLogicalComponents_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getRealizingLogicalComponents(), adaptersFactory, eResource);
    return realizingLogicalComponents_;
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.eINSTANCE.getSystem();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__ABSTRACT_TYPED_ELEMENTS:
    		return getAbstractTypedElements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_TRACES:
    		return getOwnedTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__CONTAINED_GENERIC_TRACES:
    		return getContainedGenericTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__CONTAINED_REQUIREMENTS_TRACES:
    		return getContainedRequirementsTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__NAMING_RULES:
    		return getNamingRules();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__TYPED_ELEMENTS:
    		return getTypedElements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_FUNCTIONAL_ALLOCATION:
    		return getOwnedFunctionalAllocation();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_COMPONENT_EXCHANGES:
    		return getOwnedComponentExchanges();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_COMPONENT_EXCHANGE_CATEGORIES:
    		return getOwnedComponentExchangeCategories();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__FUNCTIONAL_ALLOCATIONS:
    		return getFunctionalAllocations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__ALLOCATED_FUNCTIONS:
    		return getAllocatedFunctions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__IN_EXCHANGE_LINKS:
    		return getInExchangeLinks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OUT_EXCHANGE_LINKS:
    		return getOutExchangeLinks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_ABSTRACT_CAPABILITY_PKG:
    		return getOwnedAbstractCapabilityPkg();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_INTERFACE_PKG:
    		return getOwnedInterfacePkg();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_DATA_PKG:
    		return getOwnedDataPkg();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_STATE_MACHINES:
    		return getOwnedStateMachines();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__ABSTRACT:
    		return isAbstract() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_GENERALIZATIONS:
    		return getOwnedGeneralizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__SUPER_GENERALIZATIONS:
    		return getSuperGeneralizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__SUB_GENERALIZATIONS:
    		return getSubGeneralizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__SUPER:
    		return getSuper();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__SUB:
    		return getSub();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_FEATURES:
    		return getOwnedFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__CONTAINED_PROPERTIES:
    		return getContainedProperties();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_PARTITIONS:
    		return getOwnedPartitions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__REPRESENTING_PARTITIONS:
    		return getRepresentingPartitions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_INTERFACE_ALLOCATIONS:
    		return getOwnedInterfaceAllocations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__PROVISIONED_INTERFACE_ALLOCATIONS:
    		return getProvisionedInterfaceAllocations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__ALLOCATED_INTERFACES:
    		return getAllocatedInterfaces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_COMMUNICATION_LINKS:
    		return getOwnedCommunicationLinks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__PRODUCE:
    		return getProduce();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__CONSUME:
    		return getConsume();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__SEND:
    		return getSend();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__RECEIVE:
    		return getReceive();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__CALL:
    		return getCall();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__EXECUTE:
    		return getExecute();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__WRITE:
    		return getWrite();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__ACCESS:
    		return getAccess();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__ACQUIRE:
    		return getAcquire();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__TRANSMIT:
    		return getTransmit();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_INTERFACE_USES:
    		return getOwnedInterfaceUses();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__USED_INTERFACE_LINKS:
    		return getUsedInterfaceLinks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__USED_INTERFACES:
    		return getUsedInterfaces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_INTERFACE_IMPLEMENTATIONS:
    		return getOwnedInterfaceImplementations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__IMPLEMENTED_INTERFACE_LINKS:
    		return getImplementedInterfaceLinks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__IMPLEMENTED_INTERFACES:
    		return getImplementedInterfaces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__PROVISIONED_COMPONENT_ALLOCATIONS:
    		return getProvisionedComponentAllocations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__PROVISIONING_COMPONENT_ALLOCATIONS:
    		return getProvisioningComponentAllocations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__ALLOCATED_COMPONENTS:
    		return getAllocatedComponents();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__ALLOCATING_COMPONENTS:
    		return getAllocatingComponents();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__PROVIDED_INTERFACES:
    		return getProvidedInterfaces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__REQUIRED_INTERFACES:
    		return getRequiredInterfaces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__CONTAINED_COMPONENT_PORTS:
    		return getContainedComponentPorts();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__CONTAINED_PARTS:
    		return getContainedParts();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__CONTAINED_PHYSICAL_PORTS:
    		return getContainedPhysicalPorts();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_PHYSICAL_PATH:
    		return getOwnedPhysicalPath();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_PHYSICAL_LINKS:
    		return getOwnedPhysicalLinks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_PHYSICAL_LINK_CATEGORIES:
    		return getOwnedPhysicalLinkCategories();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__INVOLVING_INVOLVEMENTS:
    		return getInvolvingInvolvements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__INVOLVING_CAPABILITY_REALIZATION_INVOLVEMENTS:
    		return getInvolvingCapabilityRealizationInvolvements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__CONTRIBUTED_CAPABILITIES:
    		return getContributedCapabilities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__PARTICIPATIONS_IN_CAPABILITIES:
    		return getParticipationsInCapabilities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__CONTRIBUTED_MISSIONS:
    		return getContributedMissions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__PARTICIPATIONS_IN_MISSIONS:
    		return getParticipationsInMissions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__EXTERNAL_COMMUNICATION:
    		return getExternalCommunication();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_ENTITY_REALIZATIONS:
    		return getOwnedEntityRealizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__ALLOCATED_ENTITY_REALIZATIONS:
    		return getAllocatedEntityRealizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__ALLOCATED_SYSTEM_FUNCTIONS:
    		return getAllocatedSystemFunctions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__REALIZED_ENTITIES:
    		return getRealizedEntities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__REALIZING_LOGICAL_COMPONENTS:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__EXTERNAL_COMMUNICATION:
    		return getExternalCommunication() != null && !getExternalCommunication().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_ENTITY_REALIZATIONS:
    		return getOwnedEntityRealizations() != null && !getOwnedEntityRealizations().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__ALLOCATED_ENTITY_REALIZATIONS:
    		return getAllocatedEntityRealizations() != null && !getAllocatedEntityRealizations().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__ALLOCATED_SYSTEM_FUNCTIONS:
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__REALIZING_LOGICAL_COMPONENTS:
    		return getRealizingLogicalComponents() != null && !getRealizingLogicalComponents().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__EXTERNAL_COMMUNICATION:
    		...
    		getExternalCommunication().addAll((Collection) newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__OWNED_ENTITY_REALIZATIONS:
    		getOwnedEntityRealizations().clear();
    		getOwnedEntityRealizations().addAll((Collection) newValue);
    		return;
    }
  ...
  public int eBaseStructuralFeatureID(final int derivedFeatureID, final Class<?> baseClass) {
    ...
    if (baseClass == org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapabilityRealizationInvolvedElement.class) {
    	switch (derivedFeatureID) {
    		case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__INVOLVING_CAPABILITY_REALIZATION_INVOLVEMENTS:
    			return org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.CAPABILITY_REALIZATION_INVOLVED_ELEMENT__INVOLVING_CAPABILITY_REALIZATION_INVOLVEMENTS;
    		default: return -1;
    	}
    }
    ...
    if (baseClass == org.gemoc.scenario.xdsml.functionscenariomt.capellacore.InvolvedElement.class) {
    	switch (baseFeatureID) {
    		case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.INVOLVED_ELEMENT__INVOLVING_INVOLVEMENTS:
    			return org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__INVOLVING_INVOLVEMENTS;
    		default: return -1;
    	}
    }
    if (baseClass == org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapabilityRealizationInvolvedElement.class) {
    	switch (baseFeatureID) {
    		case org.gemoc.scenario.xdsml.functionscenariomt.capellacommon.CapellacommonPackage.CAPABILITY_REALIZATION_INVOLVED_ELEMENT__INVOLVING_CAPABILITY_REALIZATION_INVOLVEMENTS:
    			return org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.SYSTEM__INVOLVING_CAPABILITY_REALIZATION_INVOLVEMENTS;
    		default: return -1;
    	}
    }
