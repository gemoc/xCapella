...
public class CapabilityPkgAdapter extends EObjectAdapter<CapabilityPkg> implements org.gemoc.scenario.xdsml.functionscenariomt.ctx.CapabilityPkg {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public CapabilityPkgAdapter() {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Capability> */Object ownedCapabilities_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Capability> */Object getOwnedCapabilities() {
    if (ownedCapabilities_ == null)
    	ownedCapabilities_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedCapabilities(), adaptersFactory, eResource);
    return ownedCapabilities_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.CapabilityPkg> */Object ownedCapabilityPkgs_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.CapabilityPkg> */Object getOwnedCapabilityPkgs() {
    if (ownedCapabilityPkgs_ == null)
    	ownedCapabilityPkgs_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedCapabilityPkgs(), adaptersFactory, eResource);
    return ownedCapabilityPkgs_;
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.eINSTANCE.getCapabilityPkg();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OWNED_TRACES:
    		return getOwnedTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__CONTAINED_GENERIC_TRACES:
    		return getContainedGenericTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__CONTAINED_REQUIREMENTS_TRACES:
    		return getContainedRequirementsTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__NAMING_RULES:
    		return getNamingRules();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OWNED_PROPERTY_VALUE_PKGS:
    		return getOwnedPropertyValuePkgs();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OWNED_CAPABILITIES:
    		return getOwnedCapabilities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OWNED_CAPABILITY_PKGS:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OWNED_CAPABILITIES:
    		return getOwnedCapabilities() != null && !getOwnedCapabilities().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OWNED_CAPABILITY_PKGS:
    		return getOwnedCapabilityPkgs() != null && !getOwnedCapabilityPkgs().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OWNED_CAPABILITIES:
    		...
    		getOwnedCapabilities().addAll((Collection) newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY_PKG__OWNED_CAPABILITY_PKGS:
    		getOwnedCapabilityPkgs().clear();
    		getOwnedCapabilityPkgs().addAll((Collection) newValue);
    		return;
    }
