...
public class SharedPkgAdapter extends EObjectAdapter<SharedPkg> implements org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedPkg {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public SharedPkgAdapter() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.GenericPkg getOwnedGenericPkg() {
    return () adaptersFactory.createAdapter(adaptee.getOwnedGenericPkg(), eResource);
  }
  
  @Override
  public void setOwnedGenericPkg(final org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.GenericPkg o) {
    if (o != null)
    	adaptee.setOwnedGenericPkg(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.sharedmodel.GenericPkgAdapter) o).getAdaptee());
    else adaptee.setOwnedGenericPkg(null);
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.eINSTANCE.getSharedPkg();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__OWNED_TRACES:
    		return getOwnedTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__CONTAINED_GENERIC_TRACES:
    		return getContainedGenericTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__CONTAINED_REQUIREMENTS_TRACES:
    		return getContainedRequirementsTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__NAMING_RULES:
    		return getNamingRules();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__OWNED_PROPERTY_VALUE_PKGS:
    		return getOwnedPropertyValuePkgs();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__REUSE_LINKS:
    		return getReuseLinks();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__OWNED_DATA_PKG:
    		return getOwnedDataPkg();
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__OWNED_GENERIC_PKG:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__OWNED_GENERIC_PKG:
    		return getOwnedGenericPkg() != null;
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.SharedmodelPackage.SHARED_PKG__OWNED_GENERIC_PKG:
    		setOwnedGenericPkg(
    		(org.gemoc.scenario.xdsml.functionscenariomt.sharedmodel.GenericPkg)
    		 newValue);
    		return;
    }
