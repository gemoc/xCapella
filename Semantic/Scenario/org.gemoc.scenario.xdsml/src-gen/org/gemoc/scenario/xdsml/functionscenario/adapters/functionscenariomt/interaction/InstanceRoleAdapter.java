...
public class InstanceRoleAdapter extends EObjectAdapter<InstanceRole> implements org.gemoc.scenario.xdsml.functionscenariomt.interaction.InstanceRole {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public InstanceRoleAdapter() {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractEnd> */Object abstractEnds_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.interaction.AbstractEnd> */Object getAbstractEnds() {
    if (abstractEnds_ == null)
    	abstractEnds_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getAbstractEnds(), adaptersFactory, eResource);
    return abstractEnds_;
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.information.AbstractInstance getRepresentedInstance() {
    return () adaptersFactory.createAdapter(adaptee.getRepresentedInstance(), eResource);
  }
  
  @Override
  public void setRepresentedInstance(final org.gemoc.scenario.xdsml.functionscenariomt.information.AbstractInstance o) {
    if (o != null)
    	adaptee.setRepresentedInstance(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.information.AbstractInstanceAdapter) o).getAdaptee());
    else adaptee.setRepresentedInstance(null);
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.eINSTANCE.getInstanceRole();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__ABSTRACT_ENDS:
    		return getAbstractEnds();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__REPRESENTED_INSTANCE:
    		return getRepresentedInstance();
    }
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__ABSTRACT_ENDS:
    		return getAbstractEnds() != null && !getAbstractEnds().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__REPRESENTED_INSTANCE:
    		return getRepresentedInstance() != null;
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__FEATURES:
    		...
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INSTANCE_ROLE__REPRESENTED_INSTANCE:
    		setRepresentedInstance(
    		(org.gemoc.scenario.xdsml.functionscenariomt.information.AbstractInstance)
    		 newValue);
    		return;
    }
