...
public class GeneralizationAdapter extends EObjectAdapter<Generalization> implements org.gemoc.scenario.xdsml.functionscenariomt.capellacore.Generalization {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.capellacore.GeneralizableElement getSuper() {
    return () adaptersFactory.createAdapter(adaptee.getSuper(), eResource);
  }
  
  @Override
  public void setSuper(final org.gemoc.scenario.xdsml.functionscenariomt.capellacore.GeneralizableElement o) {
    if (o != null)
    	adaptee.setSuper(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.capellacore.GeneralizableElementAdapter) o).getAdaptee());
    else adaptee.setSuper(null);
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.capellacore.GeneralizableElement getSub() {
    return () adaptersFactory.createAdapter(adaptee.getSub(), eResource);
  }
  
  @Override
  public void setSub(final org.gemoc.scenario.xdsml.functionscenariomt.capellacore.GeneralizableElement o) {
    if (o != null)
    	adaptee.setSub(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.capellacore.GeneralizableElementAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.eINSTANCE.getGeneralization();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__REALIZED_FLOW:
    		return getRealizedFlow();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__SUPER:
    		return getSuper();
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__SUB:
    		return getSub();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__SUPER:
    		setSuper(
    		(org.gemoc.scenario.xdsml.functionscenariomt.capellacore.GeneralizableElement)
    		 newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.capellacore.CapellacorePackage.GENERALIZATION__SUB:
    		setSub(
