...
public class OrganisationalUnitAdapter extends EObjectAdapter<OrganisationalUnit> implements org.gemoc.scenario.xdsml.functionscenariomt.oa.OrganisationalUnit {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public OrganisationalUnitAdapter() {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.oa.OrganisationalUnitComposition> */Object organisationalUnitCompositions_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.oa.OrganisationalUnitComposition> */Object getOrganisationalUnitCompositions() {
    if (organisationalUnitCompositions_ == null)
    	organisationalUnitCompositions_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOrganisationalUnitCompositions(), adaptersFactory, eResource);
    return organisationalUnitCompositions_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.oa.CommunityOfInterestComposition> */Object communityOfInterestMemberships_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.oa.CommunityOfInterestComposition> */Object getCommunityOfInterestMemberships() {
    if (communityOfInterestMemberships_ == null)
    	communityOfInterestMemberships_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getCommunityOfInterestMemberships(), adaptersFactory, eResource);
    return communityOfInterestMemberships_;
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.eINSTANCE.getOrganisationalUnit();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__ORGANISATIONAL_UNIT_COMPOSITIONS:
    		return getOrganisationalUnitCompositions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__COMMUNITY_OF_INTEREST_MEMBERSHIPS:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__ORGANISATIONAL_UNIT_COMPOSITIONS:
    		return getOrganisationalUnitCompositions() != null && !getOrganisationalUnitCompositions().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__COMMUNITY_OF_INTEREST_MEMBERSHIPS:
    		return getCommunityOfInterestMemberships() != null && !getCommunityOfInterestMemberships().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__ORGANISATIONAL_UNIT_COMPOSITIONS:
    		...
    		getOrganisationalUnitCompositions().addAll((Collection) newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ORGANISATIONAL_UNIT__COMMUNITY_OF_INTEREST_MEMBERSHIPS:
    		getCommunityOfInterestMemberships().clear();
    		getCommunityOfInterestMemberships().addAll((Collection) newValue);
    		return;
    }
