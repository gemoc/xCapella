...
public class InteractionUseAdapter extends EObjectAdapter<InteractionUse> implements org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionUse {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public InteractionUseAdapter() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.interaction.Scenario getReferencedScenario() {
    return () adaptersFactory.createAdapter(adaptee.getReferencedScenario(), eResource);
  }
  
  @Override
  public void setReferencedScenario(final org.gemoc.scenario.xdsml.functionscenariomt.interaction.Scenario o) {
    if (o != null)
    	adaptee.setReferencedScenario(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.interaction.ScenarioAdapter) o).getAdaptee());
    else adaptee.setReferencedScenario(null);
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.interaction.Gate> */Object actualGates_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.interaction.Gate> */Object getActualGates() {
    if (actualGates_ == null)
    	actualGates_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getActualGates(), adaptersFactory, eResource);
    return actualGates_;
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.eINSTANCE.getInteractionUse();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__START:
    		return getStart();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__FINISH:
    		return getFinish();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__OWNED_GATES:
    		return getOwnedGates();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__REFERENCED_SCENARIO:
    		return getReferencedScenario();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__ACTUAL_GATES:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__REFERENCED_SCENARIO:
    		return getReferencedScenario() != null;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__ACTUAL_GATES:
    		return getActualGates() != null && !getActualGates().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__OWNED_GATES:
    		...
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.INTERACTION_USE__REFERENCED_SCENARIO:
    		setReferencedScenario(
    		(org.gemoc.scenario.xdsml.functionscenariomt.interaction.Scenario)
    		 newValue);
    		return;
    }
