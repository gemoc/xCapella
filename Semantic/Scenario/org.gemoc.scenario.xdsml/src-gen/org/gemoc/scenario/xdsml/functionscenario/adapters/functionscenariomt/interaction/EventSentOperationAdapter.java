...
public class EventSentOperationAdapter extends EObjectAdapter<EventSentOperation> implements org.gemoc.scenario.xdsml.functionscenariomt.interaction.EventSentOperation {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public EventSentOperationAdapter() {
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.eINSTANCE.getEventSentOperation();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__ABSTRACT_TYPED_ELEMENTS:
    		return getAbstractTypedElements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.interaction.InteractionPackage.EVENT_SENT_OPERATION__OPERATION:
    		return getOperation();
    }
