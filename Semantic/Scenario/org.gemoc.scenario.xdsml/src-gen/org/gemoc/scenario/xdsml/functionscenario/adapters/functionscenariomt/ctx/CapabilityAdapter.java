...
public class CapabilityAdapter extends EObjectAdapter<Capability> implements org.gemoc.scenario.xdsml.functionscenariomt.ctx.Capability {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public CapabilityAdapter() {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.ActorCapabilityInvolvement> */Object ownedActorCapabilityInvolvements_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.ActorCapabilityInvolvement> */Object getOwnedActorCapabilityInvolvements() {
    if (ownedActorCapabilityInvolvements_ == null)
    	ownedActorCapabilityInvolvements_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getOwnedActorCapabilityInvolvements(), adaptersFactory, eResource);
    return ownedActorCapabilityInvolvements_;
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCapabilityInvolvement getOwnedSystemCapabilityInvolvement() {
    return () adaptersFactory.createAdapter(adaptee.getOwnedSystemCapabilityInvolvement(), eResource);
  }
  
  @Override
  public void setOwnedSystemCapabilityInvolvement(final org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCapabilityInvolvement o) {
    if (o != null)
    	adaptee.setOwnedSystemCapabilityInvolvement(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.ctx.SystemCapabilityInvolvementAdapter) o).getAdaptee());
    else adaptee.setOwnedSystemCapabilityInvolvement(null);
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.ActorCapabilityInvolvement> */Object involvedActors_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.ActorCapabilityInvolvement> */Object getInvolvedActors() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCapabilityInvolvement getInvolvedSystem() {
  ...
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.CapabilityExploitation> */Object purposes_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.CapabilityExploitation> */Object getPurposes() {
    if (purposes_ == null)
    	purposes_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getPurposes(), adaptersFactory, eResource);
    return purposes_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Mission> */Object purposeMissions_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.ctx.Mission> */Object getPurposeMissions() {
    if (purposeMissions_ == null)
    	purposeMissions_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getPurposeMissions(), adaptersFactory, eResource);
    return purposeMissions_;
  }
  
  private /* EList<org.gemoc.scenario.xdsml.functionscenariomt.oa.OperationalCapability> */Object realizedOperationalCapabilities_;
  
  @Override
  public /* EList<org.gemoc.scenario.xdsml.functionscenariomt.oa.OperationalCapability> */Object getRealizedOperationalCapabilities() {
    if (realizedOperationalCapabilities_ == null)
    	realizedOperationalCapabilities_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getRealizedOperationalCapabilities(), adaptersFactory, eResource);
    return realizedOperationalCapabilities_;
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.eINSTANCE.getCapability();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_TRACES:
    		return getOwnedTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__CONTAINED_GENERIC_TRACES:
    		return getContainedGenericTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__CONTAINED_REQUIREMENTS_TRACES:
    		return getContainedRequirementsTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__NAMING_RULES:
    		return getNamingRules();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_PROPERTY_VALUE_PKGS:
    		return getOwnedPropertyValuePkgs();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__INVOLVED_INVOLVEMENTS:
    		return getInvolvedInvolvements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_FUNCTIONAL_CHAINS:
    		return getOwnedFunctionalChains();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__PRE_CONDITION:
    		return getPreCondition();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__POST_CONDITION:
    		return getPostCondition();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_SCENARIOS:
    		return getOwnedScenarios();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__INCOMING_CAPABILITY_ALLOCATION:
    		return getIncomingCapabilityAllocation();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OUTGOING_CAPABILITY_ALLOCATION:
    		return getOutgoingCapabilityAllocation();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__EXTENDS:
    		return getExtends();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__EXTENDING:
    		return getExtending();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__ABSTRACT_CAPABILITY_EXTENSION_POINTS:
    		return getAbstractCapabilityExtensionPoints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__SUPER_GENERALIZATIONS:
    		return getSuperGeneralizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__SUB_GENERALIZATIONS:
    		return getSubGeneralizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__INCLUDES:
    		return getIncludes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__INCLUDING:
    		return getIncluding();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__SUPER:
    		return getSuper();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__SUB:
    		return getSub();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__INCLUDED_ABSTRACT_CAPABILITIES:
    		return getIncludedAbstractCapabilities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__INCLUDING_ABSTRACT_CAPABILITIES:
    		return getIncludingAbstractCapabilities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__EXTENDED_ABSTRACT_CAPABILITIES:
    		return getExtendedAbstractCapabilities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__EXTENDING_ABSTRACT_CAPABILITIES:
    		return getExtendingAbstractCapabilities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_FUNCTIONAL_CHAIN_ABSTRACT_CAPABILITY_INVOLVEMENTS:
    		return getOwnedFunctionalChainAbstractCapabilityInvolvements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_ABSTRACT_FUNCTION_ABSTRACT_CAPABILITY_INVOLVEMENTS:
    		return getOwnedAbstractFunctionAbstractCapabilityInvolvements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__AVAILABLE_IN_STATES:
    		return getAvailableInStates();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_ABSTRACT_CAPABILITY_REALIZATIONS:
    		return getOwnedAbstractCapabilityRealizations();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__INVOLVED_ABSTRACT_FUNCTIONS:
    		return getInvolvedAbstractFunctions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__INVOLVED_FUNCTIONAL_CHAINS:
    		return getInvolvedFunctionalChains();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_ACTOR_CAPABILITY_INVOLVEMENTS:
    		return getOwnedActorCapabilityInvolvements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_SYSTEM_CAPABILITY_INVOLVEMENT:
    		return getOwnedSystemCapabilityInvolvement();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__INVOLVED_ACTORS:
    		return getInvolvedActors();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__INVOLVED_SYSTEM:
    		return getInvolvedSystem();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__PARTICIPATING_ACTORS:
    		return getParticipatingActors();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__PARTICIPATING_SYSTEM:
    		return getParticipatingSystem();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__PURPOSES:
    		return getPurposes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__PURPOSE_MISSIONS:
    		return getPurposeMissions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__REALIZED_OPERATIONAL_CAPABILITIES:
    		return getRealizedOperationalCapabilities();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__REALIZING_CAPABILITY_REALIZATIONS:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_ACTOR_CAPABILITY_INVOLVEMENTS:
    		return getOwnedActorCapabilityInvolvements() != null && !getOwnedActorCapabilityInvolvements().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_SYSTEM_CAPABILITY_INVOLVEMENT:
    		return getOwnedSystemCapabilityInvolvement() != null;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__INVOLVED_ACTORS:
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__PURPOSES:
    		return getPurposes() != null && !getPurposes().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__PURPOSE_MISSIONS:
    		return getPurposeMissions() != null && !getPurposeMissions().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__REALIZED_OPERATIONAL_CAPABILITIES:
    		return getRealizedOperationalCapabilities() != null && !getRealizedOperationalCapabilities().isEmpty();
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__REALIZING_CAPABILITY_REALIZATIONS:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_ACTOR_CAPABILITY_INVOLVEMENTS:
    		...
    		getOwnedActorCapabilityInvolvements().addAll((Collection) newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__OWNED_SYSTEM_CAPABILITY_INVOLVEMENT:
    		setOwnedSystemCapabilityInvolvement(
    		(org.gemoc.scenario.xdsml.functionscenariomt.ctx.SystemCapabilityInvolvement)
    		 newValue);
    		return;
    	case org.gemoc.scenario.xdsml.functionscenariomt.ctx.CtxPackage.CAPABILITY__PURPOSES:
    		getPurposes().clear();
    		getPurposes().addAll((Collection) newValue);
    		return;
    }
