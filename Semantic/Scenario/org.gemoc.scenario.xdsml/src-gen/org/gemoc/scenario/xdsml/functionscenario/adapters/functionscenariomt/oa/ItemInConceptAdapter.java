...
public class ItemInConceptAdapter extends EObjectAdapter<ItemInConcept> implements org.gemoc.scenario.xdsml.functionscenariomt.oa.ItemInConcept {
  private FunctionScenarioMTAdaptersFactory adaptersFactory;
  
  public ItemInConceptAdapter() {
  ...
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.oa.Concept getConcept() {
    return () adaptersFactory.createAdapter(adaptee.getConcept(), eResource);
  }
  
  @Override
  public void setConcept(final org.gemoc.scenario.xdsml.functionscenariomt.oa.Concept o) {
    if (o != null)
    	adaptee.setConcept(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.oa.ConceptAdapter) o).getAdaptee());
    else adaptee.setConcept(null);
  }
  
  @Override
  public org.gemoc.scenario.xdsml.functionscenariomt.oa.AbstractConceptItem getItem() {
    return () adaptersFactory.createAdapter(adaptee.getItem(), eResource);
  }
  
  @Override
  public void setItem(final org.gemoc.scenario.xdsml.functionscenariomt.oa.AbstractConceptItem o) {
    if (o != null)
    	adaptee.setItem(((org.gemoc.scenario.xdsml.functionscenario.adapters.functionscenariomt.oa.AbstractConceptItemAdapter) o).getAdaptee());
    else adaptee.setItem(null);
  }
  ...
  public EClass eClass() {
    return org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.eINSTANCE.getItemInConcept();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__OWNED_EXTENSIONS:
    		return getOwnedExtensions();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__ID:
    		return getId();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__SID:
    		return getSid();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__CONSTRAINTS:
    		return getConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__OWNED_CONSTRAINTS:
    		return getOwnedConstraints();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__NAME:
    		return getName();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__INCOMING_TRACES:
    		return getIncomingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__OUTGOING_TRACES:
    		return getOutgoingTraces();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__VISIBLE_IN_DOC:
    		return isVisibleInDoc() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__VISIBLE_IN_LM:
    		return isVisibleInLM() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__SUMMARY:
    		return getSummary();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__REVIEW:
    		return getReview();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__OWNED_PROPERTY_VALUES:
    		return getOwnedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__OWNED_ENUMERATION_PROPERTY_TYPES:
    		return getOwnedEnumerationPropertyTypes();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__APPLIED_PROPERTY_VALUES:
    		return getAppliedPropertyValues();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__OWNED_PROPERTY_VALUE_GROUPS:
    		return getOwnedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__APPLIED_PROPERTY_VALUE_GROUPS:
    		return getAppliedPropertyValueGroups();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__STATUS:
    		return getStatus();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__FEATURES:
    		return getFeatures();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__APPLIED_REQUIREMENTS:
    		return getAppliedRequirements();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__CONCEPT:
    		return getConcept();
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__ITEM:
    		return getItem();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.scenario.xdsml.functionscenariomt.oa.OaPackage.ITEM_IN_CONCEPT__ITEM:
    		setItem(
    		(org.gemoc.scenario.xdsml.functionscenariomt.oa.AbstractConceptItem)
    		 newValue);
    		return;
    }
