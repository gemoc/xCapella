 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ExceptionHandler#getProtectedNode <em>Protected Node</em>}</li>
 *   <li>{@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ExceptionHandler#getHandlerBody <em>Handler Body</em>}</li>
 *   <li>{@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ExceptionHandler#getExceptionInput <em>Exception Input</em>}</li>
 *   <li>{@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ExceptionHandler#getExceptionTypes <em>Exception Types</em>}</li>
 * </ul>
 *
 * @see org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityPackage#getExceptionHandler()
 * @model abstract="true"
...
public interface ExceptionHandler extends ModelElement {
	 ...
	 * It is bidirectional and its opposite is '{@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ExecutableNode#getOwnedHandlers <em>Owned Handlers</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityPackage#getExceptionHandler_ProtectedNode()
	...
	/**
	 * Sets the value of the '{@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ExceptionHandler#getProtectedNode <em>Protected Node</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityPackage#getExceptionHandler_HandlerBody()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ExceptionHandler#getHandlerBody <em>Handler Body</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityPackage#getExceptionHandler_ExceptionInput()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ExceptionHandler#getExceptionInput <em>Exception Input</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.modellingcore.AbstractType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityPackage#getExceptionHandler_ExceptionTypes()
	 * @model required="true"
