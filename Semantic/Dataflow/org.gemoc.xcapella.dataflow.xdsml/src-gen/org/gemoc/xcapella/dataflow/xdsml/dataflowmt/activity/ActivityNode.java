 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityNode#getInActivityPartition <em>In Activity Partition</em>}</li>
 *   <li>{@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityNode#getInInterruptibleRegion <em>In Interruptible Region</em>}</li>
 *   <li>{@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityNode#getInStructuredNode <em>In Structured Node</em>}</li>
 *   <li>{@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityNode#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityNode#getIncoming <em>Incoming</em>}</li>
 * </ul>
 *
 * @see org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityPackage#getActivityNode()
...
public interface ActivityNode extends AbstractNamedElement {
	 ...
	 * @see org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityPackage#getActivityNode_InActivityPartition()
	 ...
	 * @see org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityPackage#getActivityNode_InInterruptibleRegion()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityPackage#getActivityNode_InStructuredNode()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityPackage#getActivityNode_Outgoing()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see org.gemoc.xcapella.dataflow.xdsml.dataflowmt.activity.ActivityPackage#getActivityNode_Incoming()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
