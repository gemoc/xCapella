/**
 */
package org.gemoc.xcapella.dataflow.xdsml.dataflowmt.capellamodeller.util;
...
public class CapellamodellerSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CapellamodellerPackage.FUNCTION_RUNTIME_DATA_ASPECT: {
				FunctionRuntimeDataAspect functionRuntimeDataAspect = (FunctionRuntimeDataAspect)theEObject;
				T result = caseFunctionRuntimeDataAspect(functionRuntimeDataAspect);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CapellamodellerPackage.FUNCTIONAL_CHAIN_RUNTIME_DATA_ASPECT: {
				FunctionalChainRuntimeDataAspect functionalChainRuntimeDataAspect = (FunctionalChainRuntimeDataAspect)theEObject;
				T result = caseFunctionalChainRuntimeDataAspect(functionalChainRuntimeDataAspect);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Function Runtime Data Aspect</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Function Runtime Data Aspect</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFunctionRuntimeDataAspect(FunctionRuntimeDataAspect object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Functional Chain Runtime Data Aspect</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Functional Chain Runtime Data Aspect</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFunctionalChainRuntimeDataAspect(FunctionalChainRuntimeDataAspect object) {
		return null;
	}
