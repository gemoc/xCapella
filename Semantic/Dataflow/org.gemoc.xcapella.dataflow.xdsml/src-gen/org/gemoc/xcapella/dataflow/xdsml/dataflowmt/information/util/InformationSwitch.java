...
public class InformationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case InformationPackage.CLASS: {
				org.gemoc.xcapella.dataflow.xdsml.dataflowmt.information.Class class_ = (org.gemoc.xcapella.dataflow.xdsml.dataflowmt.information.Class)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(org.gemoc.xcapella.dataflow.xdsml.dataflowmt.information.Class object) {
		return null;
	}
