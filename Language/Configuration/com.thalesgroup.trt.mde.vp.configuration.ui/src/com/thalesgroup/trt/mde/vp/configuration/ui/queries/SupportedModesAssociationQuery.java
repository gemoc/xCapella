...
/**
 * <!-- begin-user-doc -->
 * The '<em><b>[SupportedModesAssociationQuery]</b></em>' BusinessQuery defined for 
 * '<em><b>[ConfigurationPackage.eINSTANCE.getSystemConfiguration_SupportedModes()]</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class SupportedModesAssociationQuery implements IBusinessQuery {
	...
	*/
	public List<EObject> getAvailableElements(EObject elementP) {
		...
		if (null != systemEngineering) {
			Set<EObject> all = EObjectExt.getAll(systemEngineering, ModePackage.Literals.MODE_);
	...
	public List<EObject> getCurrentElements(EObject elementP, boolean onlyGeneratedP) {
		...
		if (elementP instanceof SystemConfiguration)
			currentsElements.addAll(((SystemConfiguration) elementP).getSupportedModes());
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ConfigurationPackage.eINSTANCE.getSystemConfiguration_SupportedModes());
		return eReferences;
	}
