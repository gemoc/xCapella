	...
	*/
	...
	public List<EObject> getCurrentElements(EObject elementP, boolean onlyGeneratedP) {
		...
		if (elementP instanceof SystemConfiguration)
			currentsElements.addAll(((SystemConfiguration) elementP).getAvailableComponents());
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ConfigurationPackage.eINSTANCE.getSystemConfiguration_AvailableComponents());
		return eReferences;
	}
