...
public class PortAssociationQuery implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element_p) {
		...
		if (null != systemEngineering) {
			Set<EObject> all = EObjectExt.getAll(systemEngineering, ConfigurationPackage.Literals.CONFIGURATION_PORT);
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ConfigurationPackage.eINSTANCE.getParameterValue_Port());
		return eReferences;
	}
