	...
	*/
	public List<EObject> getAvailableElements(EObject elementP) {
		...
		if (null != systemEngineering) {
			Set<EObject> all = EObjectExt.getAll(systemEngineering, CsPackage.Literals.ABSTRACT_DEPLOYMENT_LINK);
	...
	public List<EObject> getCurrentElements(EObject elementP, boolean onlyGeneratedP) {
		...
		if (elementP instanceof Deployment)
			currentsElements.addAll(((Deployment) elementP).getDeploymentLinks());
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ConfigurationPackage.eINSTANCE.getDeployment_DeploymentLinks());
		return eReferences;
	}
