...
/**
 * <!-- begin-user-doc -->
 * The '<em><b>[AvailableFunctionsAssociationQuery]</b></em>' BusinessQuery defined for 
 * '<em><b>[ConfigurationPackage.eINSTANCE.getSystemConfiguration_AvailableFunctions()]</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class AvailableFunctionsAssociationQuery implements IBusinessQuery {
	...
	*/
	public List<EObject> getAvailableElements(EObject elementP) {
		...
		if (null != systemEngineering) {
			Set<EObject> all = EObjectExt.getAll(systemEngineering, FaPackage.Literals.ABSTRACT_FUNCTION);
	...
	public List<EObject> getCurrentElements(EObject elementP, boolean onlyGeneratedP) {
		...
		if (elementP instanceof SystemConfiguration)
			currentsElements.addAll(((SystemConfiguration) elementP).getAvailableFunctions());
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ConfigurationPackage.eINSTANCE.getSystemConfiguration_AvailableFunctions());
		return eReferences;
	}
