...
/**
 * <!-- begin-user-doc -->
 * The '<em><b>[ComponentAssociationQuery]</b></em>' BusinessQuery defined for 
 * '<em><b>[ConfigurationPackage.eINSTANCE.getComponentConfiguration_Component()]</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class ComponentAssociationQuery implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element_p) {
		...
		if (null != systemEngineering) {
			Set<EObject> all = EObjectExt.getAll(systemEngineering, CsPackage.Literals.COMPONENT);
	...
	public List<EObject> getCurrentElements(EObject element_p, boolean onlyGenerated_p) {
		...
		result.add(((ComponentConfiguration) element_p).getComponent());
		return result;
	}
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ConfigurationPackage.eINSTANCE.getComponentConfiguration_Component());
		return eReferences;
	}
