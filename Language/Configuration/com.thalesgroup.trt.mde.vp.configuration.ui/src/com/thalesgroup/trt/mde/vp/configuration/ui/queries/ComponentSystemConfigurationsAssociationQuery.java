...
/**
* <!-- begin-user-doc -->
* The '<em><b>[ComponentSystemConfigurationsAssociationQuery]</b></em>' BusinessQuery defined for 
* '<em><b>[ConfigurationPackage.eINSTANCE.getSystemConfiguration_ComponentConfigurations()]</b></em>'.
* <!-- end-user-doc -->
* <p>
* </p>
*
* @generated
*/
public class ComponentSystemConfigurationsAssociationQuery implements IBusinessQuery {
	...
	*/
	...
	public List<EObject> getCurrentElements(EObject elementP, boolean onlyGeneratedP) {
		...
		if (elementP instanceof SystemConfiguration)
			currentsElements.addAll(((SystemConfiguration) elementP).getComponentConfigurations());
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ConfigurationPackage.eINSTANCE.getSystemConfiguration_ComponentConfigurations());
		return eReferences;
	}
}
