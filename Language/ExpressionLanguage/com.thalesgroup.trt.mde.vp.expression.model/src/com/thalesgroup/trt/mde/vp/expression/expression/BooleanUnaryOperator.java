 ...
 * <!-- end-user-doc -->
 * @see com.thalesgroup.trt.mde.vp.expression.expression.ExpressionPackage#getBooleanUnaryOperator()
 * @model
 * @generated
 */
public enum BooleanUnaryOperator implements Enumerator {
	 ...
	 * @generated
	 */
	private static final BooleanUnaryOperator[] VALUES_ARRAY = new BooleanUnaryOperator[]
		{
			UNSPECIFIED,
			NOT,
		};
