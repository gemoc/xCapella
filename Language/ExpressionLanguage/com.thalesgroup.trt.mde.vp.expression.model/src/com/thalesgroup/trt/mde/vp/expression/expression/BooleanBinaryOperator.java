 ...
 * <!-- end-user-doc -->
 * @see com.thalesgroup.trt.mde.vp.expression.expression.ExpressionPackage#getBooleanBinaryOperator()
 * @model
 * @generated
 */
public enum BooleanBinaryOperator implements Enumerator {
	 ...
	 * @generated
	 */
	private static final BooleanBinaryOperator[] VALUES_ARRAY = new BooleanBinaryOperator[]
		{
			AND,
			OR,
		};
