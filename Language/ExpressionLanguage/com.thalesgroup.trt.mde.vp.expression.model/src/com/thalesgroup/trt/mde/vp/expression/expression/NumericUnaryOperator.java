 ...
 * <!-- end-user-doc -->
 * @see com.thalesgroup.trt.mde.vp.expression.expression.ExpressionPackage#getNumericUnaryOperator()
 * @model
 * @generated
 */
public enum NumericUnaryOperator implements Enumerator {
	 ...
	 * @generated
	 */
	private static final NumericUnaryOperator[] VALUES_ARRAY = new NumericUnaryOperator[]
		{
			UNSPECIFIED,
			MINUS,
		};
