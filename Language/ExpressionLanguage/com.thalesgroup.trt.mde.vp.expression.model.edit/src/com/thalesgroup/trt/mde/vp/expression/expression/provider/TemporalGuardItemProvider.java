...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.trt.mde.vp.expression.expression.TemporalGuard} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(ExpressionPackage.Literals.TEMPORAL_GUARD__AFTER_DURATION);
		}
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TemporalGuard")); //$NON-NLS-1$
	}
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			"[" + getString("_UI_TemporalGuard_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
		...
		super.collectNewChildDescriptors(newChildDescriptors, object);
                // begin-extension-code
                {
                    CommandParameter commandParameter = createChildParameter
                        (ExpressionPackage.Literals.TEMPORAL_GUARD__AFTER_DURATION,
