...
/**
 * <!-- begin-user-doc -->
 * The '<em><b>[OwnedTransitionsAssociationQuery]</b></em>' BusinessQuery defined for 
 * '<em><b>[ModePackage.eINSTANCE.getModeMachine_OwnedTransitions()]</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class OwnedTransitionsAssociationQuery implements IBusinessQuery {
	...
	*/
	...
	public List<EObject> getCurrentElements(EObject elementP, boolean onlyGeneratedP) {
		...
		if (elementP instanceof ModeMachine)
			currentsElements.addAll(((ModeMachine) elementP).getOwnedTransitions());
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ModePackage.eINSTANCE.getModeMachine_OwnedTransitions());
		return eReferences;
	}
