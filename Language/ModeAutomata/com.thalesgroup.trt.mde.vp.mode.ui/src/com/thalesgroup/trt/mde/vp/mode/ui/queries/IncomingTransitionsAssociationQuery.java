...
/**
 * <!-- begin-user-doc -->
 * The '<em><b>[IncomingTransitionsAssociationQuery]</b></em>' BusinessQuery defined for 
 * '<em><b>[ModePackage.eINSTANCE.getAbstractMode_IncomingTransitions()]</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class IncomingTransitionsAssociationQuery implements IBusinessQuery {
	...
	*/
	public List<EObject> getAvailableElements(EObject elementP) {
		...
		if (null != systemEngineering) {
			Set<EObject> all = EObjectExt.getAll(systemEngineering, ModePackage.Literals.TRANSITION);
	...
	public List<EObject> getCurrentElements(EObject elementP, boolean onlyGeneratedP) {
		...
		if (elementP instanceof AbstractMode)
			currentsElements.addAll(((AbstractMode) elementP).getIncomingTransitions());
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ModePackage.eINSTANCE.getAbstractMode_IncomingTransitions());
		return eReferences;
	}
