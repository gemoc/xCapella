...
/**
 * <!-- begin-user-doc -->
 * The '<em><b>[TriggerAssociationQuery]</b></em>' BusinessQuery defined for 
 * '<em><b>[ModePackage.eINSTANCE.getTransition_Trigger()]</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class TriggerAssociationQuery implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element_p) {
		...
		if (null != systemEngineering) {
			Set<EObject> all = EObjectExt.getAll(systemEngineering, ExpressionPackage.Literals.EVENT_EXPRESSION);
	...
	public List<EObject> getCurrentElements(EObject element_p, boolean onlyGenerated_p) {
		...
		result.add(((Transition) element_p).getTrigger());
		return result;
	}
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ModePackage.eINSTANCE.getTransition_Trigger());
		return eReferences;
	}
