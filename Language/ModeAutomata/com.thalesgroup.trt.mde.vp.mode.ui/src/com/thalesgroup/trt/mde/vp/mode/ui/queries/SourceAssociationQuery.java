...
/**
 * <!-- begin-user-doc -->
 * The '<em><b>[SourceAssociationQuery]</b></em>' BusinessQuery defined for 
 * '<em><b>[ModePackage.eINSTANCE.getTransition_Source()]</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class SourceAssociationQuery implements IBusinessQuery {
	...
	public List<CapellaElement> getCurrentElements(CapellaElement element_p,
		...
		result.add(((Transition) element_p).getSource());
		return result;
	}
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ModePackage.eINSTANCE.getTransition_Source());
		return eReferences;
	}
