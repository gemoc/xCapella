...
/**
 * <!-- begin-user-doc -->
 * The '<em><b>[InputSignalsAssociationQuery]</b></em>' BusinessQuery defined for 
 * '<em><b>[ModePackage.eINSTANCE.getModeMachine_InputSignals()]</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class InputSignalsAssociationQuery implements IBusinessQuery {
	...
	*/
	...
	public List<EObject> getCurrentElements(EObject elementP, boolean onlyGeneratedP) {
		...
		if (elementP instanceof ModeMachine)
			currentsElements.addAll(((ModeMachine) elementP).getInputSignals());
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ModePackage.eINSTANCE.getModeMachine_InputSignals());
		return eReferences;
	}
