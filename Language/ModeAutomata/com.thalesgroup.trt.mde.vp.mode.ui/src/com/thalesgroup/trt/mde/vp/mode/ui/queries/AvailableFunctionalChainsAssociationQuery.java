...
/**
 * <!-- begin-user-doc -->
 * The '<em><b>[AvailableFunctionalChainsAssociationQuery]</b></em>' BusinessQuery defined for 
 * '<em><b>[ModePackage.eINSTANCE.getMode__AvailableFunctionalChains()]</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class AvailableFunctionalChainsAssociationQuery implements IBusinessQuery {
	...
	*/
	public List<EObject> getAvailableElements(EObject elementP) {
		...
		if (null != systemEngineering) {
			Set<EObject> all = EObjectExt.getAll(systemEngineering, FaPackage.Literals.FUNCTIONAL_CHAIN);
	...
	public List<EObject> getCurrentElements(EObject elementP, boolean onlyGeneratedP) {
		...
		if (elementP instanceof Mode_)
			currentsElements.addAll(((Mode_) elementP).getAvailableFunctionalChains());
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ModePackage.eINSTANCE.getMode__AvailableFunctionalChains());
		return eReferences;
	}
