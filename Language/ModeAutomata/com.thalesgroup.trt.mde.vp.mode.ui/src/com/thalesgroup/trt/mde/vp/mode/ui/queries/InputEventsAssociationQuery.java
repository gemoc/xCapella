...
/**
 * <!-- begin-user-doc -->
 * The '<em><b>[InputEventsAssociationQuery]</b></em>' BusinessQuery defined for 
 * '<em><b>[ModePackage.eINSTANCE.getModeMachine_InputEvents()]</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class InputEventsAssociationQuery implements IBusinessQuery {
	...
	public List<CapellaElement> getCurrentElements(CapellaElement elementP,
		...
		if (elementP instanceof ModeMachine)
			currentsElements.addAll((Collection<? extends CapellaElement>) ((ModeMachine) elementP).getInputEvents());
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(ModePackage.eINSTANCE.getModeMachine_InputEvents());
		return eReferences;
	}
