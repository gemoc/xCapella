...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.trt.mde.vp.mode.mode.Final} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FinalItemProvider extends ControlNodeItemProvider implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		...
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_Final_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
