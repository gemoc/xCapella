...
public class ReferencedExternalElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		for (EObject eObject : object.getInputEvents())
			result.add(eObject);

		for (EObject eObject : object.getInputSignals())
			result.add(eObject);

		for (EObject eObject : object.getOutputEvents())
			result.add(eObject);

		for (EObject eObject : object.getOutputSignals())
			result.add(eObject);
