...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.trt.mde.vp.time.time.TimeEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeEventItemProvider extends AbstractTypeItemProvider implements
	...
	protected void addRepetitionPropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors
				...
				(((ComposeableAdapterFactory) adapterFactory)
						...
						getResourceLocator(),
						getString("_UI_TimeEvent_repetition_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_TimeEvent_repetition_feature", "_UI_TimeEvent_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						TimePackage.Literals.TIME_EVENT__REPETITION, true,
						false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TimePackage.Literals.TIME_EVENT__WHEN);
			childrenFeatures.add(TimePackage.Literals.TIME_EVENT__EVERY);
		}
	...
	public String getText(Object object) {
		...
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_TimeEvent_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
	...
	protected void collectNewChildDescriptors(
		...
		{
			CommandParameter commandParameter = createChildParameter(
					TimePackage.Literals.TIME_EVENT__WHEN,
		...
		{
			CommandParameter commandParameter = createChildParameter(
					TimePackage.Literals.TIME_EVENT__EVERY,
					TimeFactory.eINSTANCE.createDuration());
			if (NewChildDescriptorHelper.isValidCommand(object,
					commandParameter)) {
				newChildDescriptors.add(commandParameter);
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == TimePackage.Literals.TIME_EVENT__WHEN
				|| childFeature == TimePackage.Literals.TIME_EVENT__EVERY;
