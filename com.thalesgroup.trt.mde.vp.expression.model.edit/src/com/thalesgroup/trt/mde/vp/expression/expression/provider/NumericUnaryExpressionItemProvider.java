...
/**
 * This is the item provider adapter for a {@link com.thalesgroup.trt.mde.vp.expression.expression.NumericUnaryExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NumericUnaryExpressionItemProvider extends
	 ...
	 * @generated
	 */
	public NumericUnaryExpressionItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addOperandPropertyDescriptor(Object object) {
		...
		// end-extension-code		
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NumericUnaryExpression_operand_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_NumericUnaryExpression_operand_feature", "_UI_NumericUnaryExpression_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ExpressionPackage.Literals.NUMERIC_UNARY_EXPRESSION__OPERAND,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOperatorPropertyDescriptor(Object object) {
		...
		// end-extension-code
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NumericUnaryExpression_operator_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_NumericUnaryExpression_operator_feature", "_UI_NumericUnaryExpression_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ExpressionPackage.Literals.NUMERIC_UNARY_EXPRESSION__OPERATOR,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns NumericUnaryExpression.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NumericUnaryExpression")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		String label = ((NumericUnaryExpression)object).getName();
		// begin-extension-code
		return label == null || label.length() == 0 ?
			"[" + getString("_UI_NumericUnaryExpression_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NumericUnaryExpression.class))
		{
