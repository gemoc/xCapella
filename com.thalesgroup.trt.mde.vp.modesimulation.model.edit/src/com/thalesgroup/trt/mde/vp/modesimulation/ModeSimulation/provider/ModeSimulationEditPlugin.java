...
/**
 * This is the central singleton for the ModeSimulation edit plugin.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public final class ModeSimulationEditPlugin extends EMFPlugin {
	/**
	 ...
	 * @generated
	 */
	public static final ModeSimulationEditPlugin INSTANCE = new ModeSimulationEditPlugin();
	 ...
	 * @generated
	 */
	public ModeSimulationEditPlugin() {
		super(
				new ResourceLocator[] { ActivityEditPlugin.INSTANCE,
						CapellaModellerEditPlugin.INSTANCE,
						TimeEditPlugin.INSTANCE, AlEditPlugin.INSTANCE,
						ModeEditPlugin.INSTANCE, EmdeEditPlugin.INSTANCE,
